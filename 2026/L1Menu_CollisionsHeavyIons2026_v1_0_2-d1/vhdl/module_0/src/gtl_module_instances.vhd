...
algo(120) <= l1_minimum_bias_zdc1n_th1_or_minimum_bias_hf1_and_bptx_and;
...
algo(123) <= l1_minimum_bias_zdc1n_th2_or_minimum_bias_hf1_and_bptx_and;
...
algo(125) <= l1_minimum_bias_zdc1n_th3_or_minimum_bias_hf1_and_bptx_and;
...
algo(127) <= l1_minimum_bias_zdc1n_th4_or_minimum_bias_hf1_and_bptx_and;
...
algo(128) <= l1_minimum_bias_zdc2n_th1_or_minimum_bias_hf1_and_bptx_and;
...
algo(129) <= l1_minimum_bias_zdc2n_th2_or_minimum_bias_hf1_and_bptx_and;
...
algo(130) <= l1_minimum_bias_zdc2n_th3_or_minimum_bias_hf1_and_bptx_and;
...
algo(131) <= l1_minimum_bias_zdc2n_th4_or_minimum_bias_hf1_and_bptx_and;
...
algo(132) <= l1_minimum_bias_zdc3n_th1_or_minimum_bias_hf1_and_bptx_and;
...
algo(133) <= l1_minimum_bias_zdc3n_th2_or_minimum_bias_hf1_and_bptx_and;
...
algo(134) <= l1_minimum_bias_zdc3n_th3_or_minimum_bias_hf1_and_bptx_and;
...
algo(135) <= l1_minimum_bias_zdc3n_th4_or_minimum_bias_hf1_and_bptx_and;
...
algo(121) <= l1_minimum_bias_zdc1n_th1_or_minimum_bias_hf2_and_bptx_and;
...
algo(118) <= l1_minimum_bias_zdc1n_th1_and_minimum_bias_hf1_and_bptx_and;
...
algo(122) <= l1_minimum_bias_zdc1n_th2_and_minimum_bias_hf1_and_bptx_and;
...
algo(124) <= l1_minimum_bias_zdc1n_th3_and_minimum_bias_hf1_and_bptx_and;
...
algo(126) <= l1_minimum_bias_zdc1n_th4_and_minimum_bias_hf1_and_bptx_and;
...
algo(119) <= l1_minimum_bias_zdc1n_th1_and_minimum_bias_hf2_and_bptx_and;
...
algo(153) <= l1_upczdc1n_th1_or_bptx_and;
...
algo(154) <= l1_upczdc1n_th2_or_bptx_and;
...
algo(155) <= l1_upczdc1n_th3_or_bptx_and;
...
algo(136) <= l1_upczdc1n_th1_and_not_minimum_bias_hf2_bptx_and;
...
algo(139) <= l1_upczdc1n_th2_and_not_minimum_bias_hf2_bptx_and;
...
algo(142) <= l1_upczdc1n_th3_and_not_minimum_bias_hf2_bptx_and;
...
algo(137) <= l1_upczdc1n_th1_xor_minimum_bias_hf1_and_bptx_and;
...
algo(140) <= l1_upczdc1n_th2_xor_minimum_bias_hf1_and_bptx_and;
...
algo(143) <= l1_upczdc1n_th3_xor_minimum_bias_hf1_and_bptx_and;
...
algo(145) <= l1_upczdc1n_th4_xor_minimum_bias_hf1_and_bptx_and;
...
algo(138) <= l1_upczdc1n_th1_xor_minimum_bias_hf2_and_bptx_and;
...
algo(141) <= l1_upczdc1n_th2_xor_minimum_bias_hf2_and_bptx_and;
...
algo(144) <= l1_upczdc1n_th3_xor_minimum_bias_hf2_and_bptx_and;
...
algo(146) <= l1_upczdc1n_th4_xor_minimum_bias_hf2_and_bptx_and;
...
algo(106) <= l1_upczdc1n_th1_xor_minimum_bias_hf1_or_same_side_bptx_and;
...
algo(110) <= l1_upczdc1n_th2_xor_minimum_bias_hf1_or_same_side_bptx_and;
...
algo(114) <= l1_upczdc1n_th3_xor_minimum_bias_hf1_or_same_side_bptx_and;
...
algo(107) <= l1_upczdc1n_th1_xor_minimum_bias_hf2_or_same_side_bptx_and;
...
algo(111) <= l1_upczdc1n_th2_xor_minimum_bias_hf2_or_same_side_bptx_and;
...
algo(115) <= l1_upczdc1n_th3_xor_minimum_bias_hf2_or_same_side_bptx_and;
...
algo(98) <= l1_upczdc1n_th1_xor_minimum_bias_hf1_asym_xor_same_side_bptx_and;
...
algo(100) <= l1_upczdc1n_th2_xor_minimum_bias_hf1_asym_xor_same_side_bptx_and;
...
algo(102) <= l1_upczdc1n_th3_xor_minimum_bias_hf1_asym_xor_same_side_bptx_and;
...
algo(99) <= l1_upczdc1n_th1_xor_minimum_bias_hf2_xor_same_side_bptx_and;
...
algo(101) <= l1_upczdc1n_th2_xor_minimum_bias_hf2_xor_same_side_bptx_and;
...
algo(103) <= l1_upczdc1n_th3_xor_minimum_bias_hf2_xor_same_side_bptx_and;
...
algo(113) <= l1_upczdc1n_th3_asym_xor_minimum_bias_hf2_and_bptx_and;
...
algo(117) <= l1_upczdc1n_th4_asym_xor_minimum_bias_hf2_and_bptx_and;
...
algo(112) <= l1_upczdc1n_th3_asym_xor_minimum_bias_hf1_and_bptx_and;
...
algo(116) <= l1_upczdc1n_th4_asym_xor_minimum_bias_hf1_and_bptx_and;
...
algo(105) <= l1_upczdc1n_th1_asym_xor_minimum_bias_hf2_and_bptx_and;
...
algo(109) <= l1_upczdc1n_th2_asym_xor_minimum_bias_hf2_and_bptx_and;
...
algo(104) <= l1_upczdc1n_th1_asym_xor_minimum_bias_hf1_and_bptx_and;
...
algo(108) <= l1_upczdc1n_th2_asym_xor_minimum_bias_hf1_and_bptx_and;
...
-- 487 L1_ZDCM30_BptxAND : ZDCM30 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcm30_bptx_and <= zdc_minus_i237 and single_ext_i0;
algo(169) <= l1_zdcm30_bptx_and;

-- 488 L1_ZDCM40_BptxAND : ZDCM40 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcm40_bptx_and <= zdc_minus_i134 and single_ext_i0;
algo(172) <= l1_zdcm40_bptx_and;

-- 489 L1_ZDCM50_BptxAND : ZDCM50 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcm50_bptx_and <= zdc_minus_i109 and single_ext_i0;
algo(174) <= l1_zdcm50_bptx_and;

-- 490 L1_ZDCP30_BptxAND : ZDCP30 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcp30_bptx_and <= zdc_plus_i241 and single_ext_i0;
algo(181) <= l1_zdcp30_bptx_and;

-- 491 L1_ZDCP40_BptxAND : ZDCP40 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcp40_bptx_and <= zdc_plus_i133 and single_ext_i0;
algo(184) <= l1_zdcp40_bptx_and;

-- 492 L1_ZDCP50_BptxAND : ZDCP50 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcp50_bptx_and <= zdc_plus_i108 and single_ext_i0;
algo(186) <= l1_zdcp50_bptx_and;

-- 493 L1_ZDCM30_MinimumBiasHF1minus_BptxAND : ZDCM30 AND (MBT0HFM1) AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcm30_minimum_bias_hf1minus_bptx_and <= zdc_minus_i237 and ( single_mbt0_hfm_i111 ) and single_ext_i0;
algo(147) <= l1_zdcm30_minimum_bias_hf1minus_bptx_and;

-- 494 L1_ZDCM30_MinimumBiasHF2minus_BptxAND : ZDCM30 AND (MBT1HFM1) AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcm30_minimum_bias_hf2minus_bptx_and <= zdc_minus_i237 and ( single_mbt1_hfm_i105 ) and single_ext_i0;
algo(149) <= l1_zdcm30_minimum_bias_hf2minus_bptx_and;

-- 495 L1_ZDCP30_MinimumBiasHF1plus_BptxAND : ZDCP30 AND (MBT0HFP1) AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcp30_minimum_bias_hf1plus_bptx_and <= zdc_plus_i241 and ( single_mbt0_hfp_i110 ) and single_ext_i0;
algo(150) <= l1_zdcp30_minimum_bias_hf1plus_bptx_and;

-- 496 L1_ZDCP30_MinimumBiasHF2plus_BptxAND : ZDCP30 AND (MBT1HFP1) AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcp30_minimum_bias_hf2plus_bptx_and <= zdc_plus_i241 and ( single_mbt1_hfp_i104 ) and single_ext_i0;
algo(152) <= l1_zdcp30_minimum_bias_hf2plus_bptx_and;

-- 499 L1_ZDCM30_SingleJet60_BptxAND : JET60 AND ZDCM30 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcm30_single_jet60_bptx_and <= single_jet_i46 and zdc_minus_i237 and single_ext_i0;
algo(94) <= l1_zdcm30_single_jet60_bptx_and;

-- 500 L1_ZDCP30_SingleJet60_BptxAND : JET60 AND ZDCP30 AND EXT_ZeroBias_BPTX_AND_VME
l1_zdcp30_single_jet60_bptx_and <= single_jet_i46 and zdc_plus_i241 and single_ext_i0;
algo(96) <= l1_zdcp30_single_jet60_bptx_and;

-- 503 L1_ZDCM30_SingleJet60_NotBptxOR : JET60 AND ZDCM30 AND  NOT EXT_BPTX_OR_VME
l1_zdcm30_single_jet60_not_bptx_or <= single_jet_i46 and zdc_minus_i237 and not single_ext_i14;
algo(95) <= l1_zdcm30_single_jet60_not_bptx_or;

-- 504 L1_ZDCP30_SingleJet60_NotBptxOR : JET60 AND ZDCP30 AND  NOT EXT_BPTX_OR_VME
l1_zdcp30_single_jet60_not_bptx_or <= single_jet_i46 and zdc_plus_i241 and not single_ext_i14;
algo(97) <= l1_zdcp30_single_jet60_not_bptx_or;

-- 505 L1_ZDCM30_NotBptxOR : ZDCM30 AND  NOT EXT_BPTX_OR_VME
l1_zdcm30_not_bptx_or <= zdc_minus_i237 and not single_ext_i14;
algo(170) <= l1_zdcm30_not_bptx_or;

-- 506 L1_ZDCP30_NotBptxOR : ZDCP30 AND  NOT EXT_BPTX_OR_VME
l1_zdcp30_not_bptx_or <= zdc_plus_i241 and not single_ext_i14;
algo(182) <= l1_zdcp30_not_bptx_or;

-- 507 L1_ZDCM30_MinimumBiasHF1minus_NotBptxOR : ZDCM30 AND (MBT0HFM1) AND  NOT EXT_BPTX_OR_VME
l1_zdcm30_minimum_bias_hf1minus_not_bptx_or <= zdc_minus_i237 and ( single_mbt0_hfm_i111 ) and not single_ext_i14;
algo(148) <= l1_zdcm30_minimum_bias_hf1minus_not_bptx_or;

-- 508 L1_ZDCP30_MinimumBiasHF1plus_NotBptxOR : ZDCP30 AND (MBT0HFP1) AND  NOT EXT_BPTX_OR_VME
l1_zdcp30_minimum_bias_hf1plus_not_bptx_or <= zdc_plus_i241 and ( single_mbt0_hfp_i110 ) and not single_ext_i14;
algo(151) <= l1_zdcp30_minimum_bias_hf1plus_not_bptx_or;
