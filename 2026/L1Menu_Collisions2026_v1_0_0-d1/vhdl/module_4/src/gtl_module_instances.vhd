...
cond_quad_jet_i487_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
        ...
        slice_4_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"001E", X"001E", X"001E", X"001E"),
        nr_eta_windows_obj1 => (1, 1, 1, 1),
        eta_w1_upper_limits_obj1 => (X"0039", X"0039", X"0039", X"0039"),
        eta_w1_lower_limits_obj1 => (X"00C6", X"00C6", X"00C6", X"00C6"),
-- number of objects and type
...
cond_double_tau_ov_rm_i443_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i443
    );
...
cond_cicada_trigger_i484: entity work.cicada_condition
    generic map(
        cscore => X"5600"
    )
    port map(
...
algo(9) <= l1_double_mu0er1p5_sq_os_d_eta_max1p2;
...
-- 172 L1_SingleEG20er2p5 : EG20[EG-ETA_2p52]
l1_single_eg20er2p5 <= single_eg_i86;
algo(33) <= l1_single_eg20er2p5;
...
l1_double_eg17_er1p5_d_eta_max1p5 <= calo_calo_correlation_i474;
algo(8) <= l1_double_eg17_er1p5_d_eta_max1p5;
...
algo(20) <= l1_double_eg_25_14_er2p5;
...
algo(14) <= l1_double_loose_iso_eg24er2p1;
...
-- 261 L1_CICADA_Parking2 : CICADA[CICADA-CSCORE_86]
l1_cicada_parking2 <= cicada_trigger_i484;
algo(63) <= l1_cicada_parking2;

-- 264 L1_SingleTau130er2p1 : TAU130[TAU-ETA_2p13]
l1_single_tau130er2p1 <= single_tau_i196;
algo(50) <= l1_single_tau130er2p1;
...
l1_double_tau_iso34_iso26_er2p1_jet55_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i443;
algo(6) <= l1_double_tau_iso34_iso26_er2p1_jet55_rm_ovlp_d_r0p5;
...
-- 283 L1_QuadJet15er2p5 : comb{JET15[JET-ETA_2p52],JET15[JET-ETA_2p52],JET15[JET-ETA_2p52],JET15[JET-ETA_2p52]}
l1_quad_jet15er2p5 <= quad_jet_i487;
algo(4) <= l1_quad_jet15er2p5;
...
-- 429 L1_CICADA_Loose : CICADA[CICADA-CSCORE_66]
l1_cicada_loose <= cicada_trigger_i409;
algo(62) <= l1_cicada_loose;

-- 432 L1_CICADA_VTight : CICADA[CICADA-CSCORE_71p25]
l1_cicada_v_tight <= cicada_trigger_i412;
algo(64) <= l1_cicada_v_tight;
