...
cond_cicada_trigger_i429: entity work.cicada_condition
    generic map(
        cscore => X"7E00"
    )
    port map(
        lhc_clk => lhc_clk,
        cicada_i => bx_data.cicada(2),
        c_comp_o => cicada_trigger_i429
    );

cond_cicada_trigger_i485: entity work.cicada_condition
    generic map(
        cscore => X"5F00"
    )
    port map(
...
l1_cicada_parking3 <= cicada_trigger_i485;
algo(64) <= l1_cicada_parking3;
...
l1_cicada_vv_tight <= cicada_trigger_i429;
