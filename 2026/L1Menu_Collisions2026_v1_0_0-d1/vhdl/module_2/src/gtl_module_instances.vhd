...
cond_single_eg_i467_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_double_tau_ov_rm_i475_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i475
    );
...
cond_single_mu_i486_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
        pt_thresholds_obj1 => (X"0019", X"0000", X"0000", X"0000"),
...
cond_topological_trigger_i490: entity work.ml_comparison
    generic map(5107, TOPO_SCORE_WIDTH)
    port map(
        topo_HHbbWW_1mu_v5_score,
        topological_trigger_i490
    );

cond_topological_trigger_i491: entity work.ml_comparison
    generic map(5583, TOPO_SCORE_WIDTH)
    port map(
        topo_HHbbWW_1mu_v5_score,
        topological_trigger_i491
    );

cond_topological_trigger_i492: entity work.ml_comparison
    generic map(6429, TOPO_SCORE_WIDTH)
    port map(
        topo_HHbbWW_1mu_v5_score,
        topological_trigger_i492
    );
...
algo(54) <= l1_single_mu_open_omtf;
...
l1_single_mu12_dq <= single_mu_i486;
algo(71) <= l1_single_mu12_dq;
...
l1_single_eg28er1p3 <= single_eg_i470;
algo(27) <= l1_single_eg28er1p3;

-- 178 L1_SingleEG28er1p3to2p5 : EG28[EG-ETA_2p52] AND  NOT EG28[EG-ETA_1p3]
l1_single_eg28er1p3to2p5 <= single_eg_i139 and not single_eg_i470;
algo(33) <= l1_single_eg28er1p3to2p5;

-- 179 L1_SingleEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52]
l1_single_eg28er2p5to3p0 <= single_eg_i468 and not single_eg_i139;
algo(35) <= l1_single_eg28er2p5to3p0;
...
l1_single_loose_iso_eg28er1p3 <= single_eg_i467;
algo(26) <= l1_single_loose_iso_eg28er1p3;

-- 195 L1_SingleLooseIsoEG28er1p3to2p5 : EG28[EG-ETA_2p52,EG-ISO_0xC] AND  NOT EG28[EG-ETA_1p3,EG-ISO_0xC]
l1_single_loose_iso_eg28er1p3to2p5 <= single_eg_i154 and not single_eg_i467;
algo(32) <= l1_single_loose_iso_eg28er1p3to2p5;

-- 196 L1_SingleLooseIsoEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52,EG-ISO_0xC]
l1_single_loose_iso_eg28er2p5to3p0 <= single_eg_i468 and not single_eg_i154;
algo(34) <= l1_single_loose_iso_eg28er2p5to3p0;
...
l1_single_iso_eg28er1p3 <= single_eg_i469;
algo(28) <= l1_single_iso_eg28er1p3;

-- 207 L1_SingleIsoEG28er1p3to2p5 : EG28[EG-ETA_2p52,EG-ISO_0xA] AND  NOT EG28[EG-ETA_1p3,EG-ISO_0xA]
l1_single_iso_eg28er1p3to2p5 <= single_eg_i164 and not single_eg_i469;
algo(24) <= l1_single_iso_eg28er1p3to2p5;

-- 208 L1_SingleIsoEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52,EG-ISO_0xA]
l1_single_iso_eg28er2p5to3p0 <= single_eg_i468 and not single_eg_i164;
...
l1_topo_loose <= topological_trigger_i490;
algo(73) <= l1_topo_loose;

-- 244 L1_TOPO_Medium : TOPO[TOPO-MODEL_HHbbWW_1mu_v5,TOPO-SCORE_Medium]
l1_topo_medium <= topological_trigger_i491;
algo(74) <= l1_topo_medium;

-- 245 L1_TOPO_Tight : TOPO[TOPO-MODEL_HHbbWW_1mu_v5,TOPO-SCORE_Tight]
l1_topo_tight <= topological_trigger_i492;
algo(75) <= l1_topo_tight;
...
l1_double_tau_iso34_iso26_er2p1_jet70_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i475;
...
algo(22) <= l1_htt240_single_llp_jet70;
