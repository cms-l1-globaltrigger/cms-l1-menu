...
cond_quad_jet_i489_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
        ...
        slice_4_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"0030", X"0030", X"0030", X"0030"),
...
cond_single_eg_i479_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_single_jet_i465_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => single_jet_i465
    );

cond_single_jet_i466_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_double_tau_ov_rm_i477_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i477
    );
...
cond_calo_calo_correlation_i471_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i471
    );
...
cond_axol1tl_trigger_i413: entity work.ml_comparison
    generic map(2899, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
...
cond_axol1tl_trigger_i414: entity work.ml_comparison
    generic map(3257, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
...
cond_axol1tl_trigger_i415: entity work.ml_comparison
    generic map(3865, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
...
cond_axol1tl_trigger_i416: entity work.ml_comparison
    generic map(7874, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
...
cond_axol1tl_trigger_i427: entity work.ml_comparison
    generic map(3541, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
...
cond_axol1tl_trigger_i428: entity work.ml_comparison
    generic map(11121, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i428
    );

cond_axol1tl_trigger_i493: entity work.ml_comparison
    generic map(10000000, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i493
    );
...
algo(55) <= l1_double_mu0_upt7_sq_er2p0;
...
algo(25) <= l1_double_mu3_sq_etmhf30_htt60er;
...
algo(15) <= l1_double_mu3_sq_etmhf30_jet60er2p5_or_double_jet40er2p5;
...
-- 171 L1_SingleEG18er2p5 : EG18[EG-ETA_2p52]
l1_single_eg18er2p5 <= single_eg_i479;
algo(75) <= l1_single_eg18er2p5;

-- 173 L1_SingleEG8er2p5 : EG8[EG-ETA_2p52]
l1_single_eg8er2p5 <= single_eg_i134;
algo(78) <= l1_single_eg8er2p5;
...
l1_double_tau_iso34_iso23_er2p1_jet70_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i477;
algo(11) <= l1_double_tau_iso34_iso23_er2p1_jet70_rm_ovlp_d_r0p5;

-- 285 L1_QuadJet24er2p5 : comb{JET24[JET-ETA_2p52],JET24[JET-ETA_2p52],JET24[JET-ETA_2p52],JET24[JET-ETA_2p52]}
l1_quad_jet24er2p5 <= quad_jet_i489;
algo(10) <= l1_quad_jet24er2p5;
...
algo(59) <= l1_mu22er2p1_iso_tau32er2p1;
...
algo(91) <= l1_single_jet35;

-- 297 L1_SingleJet60er1p3 : JET60[JET-ETA_1p3]
l1_single_jet60er1p3 <= single_jet_i465;
algo(17) <= l1_single_jet60er1p3;

-- 298 L1_SingleJet60er1p3to2p5 : JET60[JET-ETA_2p52] AND  NOT JET60[JET-ETA_1p3]
l1_single_jet60er1p3to2p5 <= single_jet_i130 and not single_jet_i465;
algo(19) <= l1_single_jet60er1p3to2p5;

-- 299 L1_SingleJet60er2p5to3p0 : JET60[JET-ETA_3p0] AND  NOT JET60[JET-ETA_2p52]
l1_single_jet60er2p5to3p0 <= single_jet_i466 and not single_jet_i130;
algo(21) <= l1_single_jet60er2p5to3p0;

-- 300 L1_SingleJet60er3p0to5p0 : JET60 AND  NOT JET60[JET-ETA_3p0]
l1_single_jet60er3p0to5p0 <= single_jet_i218 and not single_jet_i466;
...
algo(43) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p1;
...
-- 332 L1_ETMHF40 : ETMHF40
l1_etmhf40 <= single_etmhf_i118;
algo(52) <= l1_etmhf40;

-- 333 L1_ETMHF50 : ETMHF50
l1_etmhf50 <= single_etmhf_i119;
algo(16) <= l1_etmhf50;
...
l1_double_jet45_mass_min800_loose_iso_eg20er2p1_rm_ovlp_d_r0p2 <= invariant_mass_ov_rm_i440;
...
-- 421 L1_AXO_VLoose : AXO[AXO-MODEL_v6,AXO-SCORE_VLoose]
l1_axo_v_loose <= axol1tl_trigger_i413;
algo(97) <= l1_axo_v_loose;

-- 422 L1_AXO_Loose : AXO[AXO-MODEL_v6,AXO-SCORE_Loose]
l1_axo_loose <= axol1tl_trigger_i414;
algo(94) <= l1_axo_loose;

-- 423 L1_AXO_Medium : AXO[AXO-MODEL_v6,AXO-SCORE_Medium]
l1_axo_medium <= axol1tl_trigger_i427;
algo(95) <= l1_axo_medium;

-- 424 L1_AXO_Tight : AXO[AXO-MODEL_v6,AXO-SCORE_Tight]
l1_axo_tight <= axol1tl_trigger_i415;
algo(96) <= l1_axo_tight;

-- 425 L1_AXO_VTight : AXO[AXO-MODEL_v6,AXO-SCORE_VTight]
l1_axo_v_tight <= axol1tl_trigger_i416;
algo(98) <= l1_axo_v_tight;

-- 426 L1_AXO_VVTight : AXO[AXO-MODEL_v6,AXO-SCORE_VVTight]
l1_axo_vv_tight <= axol1tl_trigger_i428;
algo(99) <= l1_axo_vv_tight;

-- 427 L1_AXO_VVVTight : AXO[AXO-MODEL_v6,AXO-SCORE_VVVTight]
l1_axo_vvv_tight <= axol1tl_trigger_i493;
algo(100) <= l1_axo_vvv_tight;

-- 456 L1_SingleJet8er2p13 : JET8[JET-ETA_2p13]
l1_single_jet8er2p13 <= single_jet_i454;
algo(80) <= l1_single_jet8er2p13;
...
calc_axo_v6_i: entity work.ml_calculation_instances
    generic map(AXO_SEL, AXO_MODEL_V6, AXO_SCORE_WIDTH)
    port map(
        lhc_clk,
        bx_data.mu(2),
        bx_data.eg(2),
