...
cond_cicada_trigger_i483: entity work.cicada_condition
    generic map(
        cscore => X"535A"
    )
    port map(
...
algo(45) <= l1_single_mu_open_bmtf;
...
algo(44) <= l1_single_mu5_sq14_bmtf;
...
algo(43) <= l1_single_mu22_emtf_neg;
...
l1_double_jet_110_35_double_jet35_mass_min1000 <= double_jet_i340 and invariant_mass_i432;
...
l1_double_jet_110_35_double_jet35_mass_min1100 <= double_jet_i340 and invariant_mass_i433;
...
l1_double_jet_110_35_double_jet35_mass_min1200 <= double_jet_i340 and invariant_mass_i434;
...
l1_double_jet_65_35_double_jet35_mass_min750_double_jet_central50 <= double_jet_i347 and invariant_mass_i437 and ( ( quad_jet_i349 ) or ( triple_jet_i350 and ( single_jet_i351 or single_jet_i352 ) ) or ( triple_jet_i353 and ( single_jet_i354 or single_jet_i355 ) ) or ( triple_jet_i356 and ( single_jet_i357 or single_jet_i358 ) ) or ( double_jet_i359 and ( double_jet_i360 or double_jet_i361 or double_jet_i362 or double_jet_i363 ) ) or ( double_jet_i364 and ( double_jet_i365 or double_jet_i366 or double_jet_i367 or double_jet_i368 ) ) );
...
l1_double_jet_65_35_double_jet35_mass_min950_double_jet_central50 <= double_jet_i347 and invariant_mass_i438 and ( ( quad_jet_i349 ) or ( triple_jet_i350 and ( single_jet_i351 or single_jet_i352 ) ) or ( triple_jet_i353 and ( single_jet_i354 or single_jet_i355 ) ) or ( triple_jet_i356 and ( single_jet_i357 or single_jet_i358 ) ) or ( double_jet_i359 and ( double_jet_i360 or double_jet_i361 or double_jet_i362 or double_jet_i363 ) ) or ( double_jet_i364 and ( double_jet_i365 or double_jet_i366 or double_jet_i367 or double_jet_i368 ) ) );
...
l1_double_jet45_mass_min700_loose_iso_eg20er2p1_rm_ovlp_d_r0p2 <= invariant_mass_ov_rm_i439;
...
l1_double_jet_85_35_double_jet35_mass_min700_mu3_oq <= double_jet_i370 and invariant_mass_i441 and single_mu_i371;
...
l1_double_jet_85_35_double_jet35_mass_min900_mu3_oq <= double_jet_i370 and invariant_mass_i442 and single_mu_i371;
...
l1_double_jet_70_35_double_jet35_mass_min700_etmhf65 <= double_jet_i372 and invariant_mass_i441 and single_etmhf_i374;
...
algo(52) <= l1_cicada_v_loose;

-- 435 L1_CICADA_VVVVTight : CICADA[CICADA-CSCORE_145]
l1_cicada_vvvv_tight <= cicada_trigger_i431;
algo(53) <= l1_cicada_vvvv_tight;
