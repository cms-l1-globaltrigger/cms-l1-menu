...
constant global_index: global_index_array := (
        ...
        263, -- module_index: 38, name: L1_SingleTau120er2p1
         57, -- module_index: 39, name: L1_DoubleMu0
         63, -- module_index: 40, name: L1_DoubleMu_12_5
         12, -- module_index: 41, name: L1_SingleMu0_SQ13_BMTF
         34, -- module_index: 42, name: L1_SingleMu12_DQ_BMTF
         51, -- module_index: 43, name: L1_SingleMu22_EMTF_NEG
         25, -- module_index: 44, name: L1_SingleMu5_SQ14_BMTF
          5, -- module_index: 45, name: L1_SingleMuOpen_BMTF
        151, -- module_index: 46, name: L1_Mu12_HTT150er
        152, -- module_index: 47, name: L1_Mu14_HTT150er
        302, -- module_index: 48, name: L1_SingleJet90
         42, -- module_index: 49, name: L1_SingleMu22
          0, -- module_index: 50, name: L1_SingleMuCosmics
        260, -- module_index: 51, name: L1_CICADA_Parking1
        428, -- module_index: 52, name: L1_CICADA_VLoose
        435, -- module_index: 53, name: L1_CICADA_VVVVTight
        408, -- module_index: 54, name: L1_ETMHF150
        418, -- module_index: 55, name: L1_HTMHF125
        394, -- module_index: 56, name: L1_HTT360er
        499, -- module_index: 57, name: L1_BPTX_AND_Ref3_VME
        502, -- module_index: 58, name: L1_BPTX_BeamGas_Ref2_VME
        481, -- module_index: 59, name: L1_BptxMinus
        480, -- module_index: 60, name: L1_BptxPlus
        479, -- module_index: 61, name: L1_BptxXOR
        483, -- module_index: 62, name: L1_UnpairedBunchBptxMinus
    others => 0
);
