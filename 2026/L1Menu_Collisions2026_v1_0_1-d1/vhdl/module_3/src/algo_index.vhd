...
constant global_index: global_index_array := (
        ...
        261, -- module_index: 51, name: L1_CICADA_Parking2
        433, -- module_index: 52, name: L1_CICADA_VVTight
        407, -- module_index: 53, name: L1_ETMHF140
        418, -- module_index: 54, name: L1_HTMHF125
        394, -- module_index: 55, name: L1_HTT360er
        499, -- module_index: 56, name: L1_BPTX_AND_Ref3_VME
        502, -- module_index: 57, name: L1_BPTX_BeamGas_Ref2_VME
        481, -- module_index: 58, name: L1_BptxMinus
        480, -- module_index: 59, name: L1_BptxPlus
        479, -- module_index: 60, name: L1_BptxXOR
        483, -- module_index: 61, name: L1_UnpairedBunchBptxMinus
    others => 0
);
