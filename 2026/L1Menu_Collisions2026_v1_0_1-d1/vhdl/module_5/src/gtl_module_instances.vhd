...
cond_double_tau_i480_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"0034", X"0034", X"0000", X"0000"),
        nr_eta_windows_obj1 => (1, 1, 0, 0),
        eta_w1_upper_limits_obj1 => (X"0030", X"0030", X"0000", X"0000"),
        eta_w1_lower_limits_obj1 => (X"00CF", X"00CF", X"0000", X"0000"),
        iso_luts_obj1 => (X"E", X"E", X"F", X"F"),
...
cond_single_htt_i481_i: entity work.esums_conditions
    generic map(
        et_threshold => X"00C8",
        obj_type => HTT_TYPE
    )
    port map(
        lhc_clk,
        bx_data.htt(2),
        condition_o => single_htt_i481
    );

cond_single_htt_i482_i: entity work.esums_conditions
    generic map(
        et_threshold => X"00A0",
        obj_type => HTT_TYPE
    )
...
algo(34) <= l1_single_mu0_upt10_omtf;
...
algo(31) <= l1_double_mu18er2p1_sq;
...
algo(13) <= l1_double_mu0er2p0_sq_d_eta_max1p5;
...
algo(30) <= l1_double_mu4p5er2p0_sq_os;
...
l1_double_eg17_11_er1p2_d_r_max0p6 <= calo_calo_correlation_i472;
...
algo(63) <= l1_cicada_parking1;

-- 265 L1_DoubleIsoTau26er2p1 : comb{TAU26[TAU-ETA_2p13,TAU-ISO_0xE],TAU26[TAU-ETA_2p13,TAU-ISO_0xE]}
l1_double_iso_tau26er2p1 <= double_tau_i480;
algo(14) <= l1_double_iso_tau26er2p1;
...
-- 334 L1_HTT80er : HTT80
l1_htt80er <= single_htt_i482;
algo(68) <= l1_htt80er;

-- 335 L1_HTT100er : HTT100
l1_htt100er <= single_htt_i481;
algo(67) <= l1_htt100er;
...
l1_double_jet45_mass_min700_iso_tau45er2p1_rm_ovlp_d_r0p5 <= invariant_mass_ov_rm_i435;
