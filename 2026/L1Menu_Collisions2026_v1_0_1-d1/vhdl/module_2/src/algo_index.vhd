...
constant global_index: global_index_array := (
        ...
        431, -- module_index: 74, name: L1_CICADA_Tight
        435, -- module_index: 75, name: L1_CICADA_VVVVTight
        397, -- module_index: 76, name: L1_ETT2000
        420, -- module_index: 77, name: L1_HTMHF150
        396, -- module_index: 78, name: L1_HTT450er
        503, -- module_index: 79, name: L1_BPTX_BeamGas_B1_VME
        495, -- module_index: 80, name: L1_BPTX_OR_Ref3_VME
        492, -- module_index: 81, name: L1_FirstCollisionInTrain
        119, -- module_index: 82, name: L1_SingleMuShower_Nominal
        510, -- module_index: 83, name: L1_TOTEM_3
    others => 0
);
