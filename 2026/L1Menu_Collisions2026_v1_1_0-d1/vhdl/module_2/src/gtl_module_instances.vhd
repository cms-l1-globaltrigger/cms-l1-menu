...
cond_single_eg_i452_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_single_eg_i464_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_triple_jet_i489_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
        slice_3_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"0028", X"0028", X"0028", X"0000"),
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => triple_jet_i489
    );

cond_triple_jet_i490_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
        slice_3_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"003C", X"003C", X"003C", X"0000"),
        nr_eta_windows_obj1 => (1, 1, 1, 0),
        eta_w1_upper_limits_obj1 => (X"0039", X"0039", X"0039", X"0000"),
        eta_w1_lower_limits_obj1 => (X"00C6", X"00C6", X"00C6", X"0000"),
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => triple_jet_i490
    );

cond_double_tau_ov_rm_i469_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i469
    );
...
cond_single_mu_i416_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
        pt_thresholds_obj1 => (X"002D", X"0000", X"0000", X"0000"),
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_muon => bx_data. mu(2),
        condition_o => single_mu_i416
    );

cond_single_mu_i480_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
        pt_thresholds_obj1 => (X"0019", X"0000", X"0000", X"0000"),
...
cond_calo_calo_correlation_i422_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i422
    );
...
cond_topological_trigger_i484: entity work.ml_comparison
    generic map(5107, TOPO_SCORE_WIDTH)
    port map(
        topo_HHbbWW_1mu_v5_score,
        topological_trigger_i484
    );

cond_topological_trigger_i485: entity work.ml_comparison
    generic map(5583, TOPO_SCORE_WIDTH)
    port map(
        topo_HHbbWW_1mu_v5_score,
        topological_trigger_i485
    );

cond_topological_trigger_i486: entity work.ml_comparison
    generic map(6429, TOPO_SCORE_WIDTH)
    port map(
        topo_HHbbWW_1mu_v5_score,
        topological_trigger_i486
    );
...
algo(64) <= l1_single_mu12_dq_bmtf;
...
algo(80) <= l1_single_mu_shower_nominal;
...
l1_single_eg28er1p3 <= single_eg_i464;
algo(27) <= l1_single_eg28er1p3;

-- 178 L1_SingleEG28er1p3to2p5 : EG28[EG-ETA_2p52] AND  NOT EG28[EG-ETA_1p3]
l1_single_eg28er1p3to2p5 <= single_eg_i139 and not single_eg_i464;
algo(32) <= l1_single_eg28er1p3to2p5;

-- 179 L1_SingleEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52]
l1_single_eg28er2p5to3p0 <= single_eg_i462 and not single_eg_i139;
...
l1_single_loose_iso_eg28er1p3 <= single_eg_i461;
...
l1_single_loose_iso_eg28er1p3to2p5 <= single_eg_i154 and not single_eg_i461;
algo(28) <= l1_single_loose_iso_eg28er1p3to2p5;

-- 196 L1_SingleLooseIsoEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52,EG-ISO_0xC]
l1_single_loose_iso_eg28er2p5to3p0 <= single_eg_i462 and not single_eg_i154;
algo(30) <= l1_single_loose_iso_eg28er2p5to3p0;
...
l1_single_iso_eg28er1p3to2p5 <= single_eg_i164 and not single_eg_i463;
algo(24) <= l1_single_iso_eg28er1p3to2p5;

-- 208 L1_SingleIsoEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52,EG-ISO_0xA]
l1_single_iso_eg28er2p5to3p0 <= single_eg_i462 and not single_eg_i164;
...
algo(50) <= l1_single_iso_eg32er2p5;
...
l1_double_eg15_er1p5_d_eta_max1p5 <= calo_calo_correlation_i422;
...
-- 243 L1_TOPO_Loose : TOPO[TOPO-MODEL_HHbbWW_1mu_v5,TOPO-SCORE_Loose]
l1_topo_loose <= topological_trigger_i484;
algo(72) <= l1_topo_loose;

-- 244 L1_TOPO_Medium : TOPO[TOPO-MODEL_HHbbWW_1mu_v5,TOPO-SCORE_Medium]
l1_topo_medium <= topological_trigger_i485;
algo(73) <= l1_topo_medium;

-- 245 L1_TOPO_Tight : TOPO[TOPO-MODEL_HHbbWW_1mu_v5,TOPO-SCORE_Tight]
l1_topo_tight <= topological_trigger_i486;
...
l1_double_tau_iso34_iso26_er2p1_jet70_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i469;
...
-- 322 L1_TripleJet20er2p5 : comb{JET20[JET-ETA_2p52],JET20[JET-ETA_2p52],JET20[JET-ETA_2p52]}
l1_triple_jet20er2p5 <= triple_jet_i489;
algo(17) <= l1_triple_jet20er2p5;

-- 324 L1_TripleJet30er2p5 : comb{JET30[JET-ETA_2p52],JET30[JET-ETA_2p52],JET30[JET-ETA_2p52]}
l1_triple_jet30er2p5 <= triple_jet_i490;
algo(18) <= l1_triple_jet30er2p5;
