...
constant global_index: global_index_array := (
        ...
        308, -- module_index: 37, name: L1_SingleJet120er1p3
        306, -- module_index: 38, name: L1_SingleJet35er1p3
         54, -- module_index: 39, name: L1_SingleMu0_Upt20_SQ14_BMTF
         59, -- module_index: 40, name: L1_DoubleMu0_SQ_OS
         58, -- module_index: 41, name: L1_DoubleMu0_SQ
         65, -- module_index: 42, name: L1_DoubleMu_15_7
         14, -- module_index: 43, name: L1_SingleMu0_SQ15_BMTF
         43, -- module_index: 44, name: L1_SingleMu22_BMTF
         49, -- module_index: 45, name: L1_SingleMu22_OMTF_NEG
         27, -- module_index: 46, name: L1_SingleMu7_SQ14_BMTF
        381, -- module_index: 47, name: L1_HTT160_SingleLLPJet50
        389, -- module_index: 48, name: L1_HTT160er
        304, -- module_index: 49, name: L1_SingleJet180
         38, -- module_index: 50, name: L1_SingleMu18
         21, -- module_index: 51, name: L1_SingleMu7_DQ
        260, -- module_index: 52, name: L1_CICADA_Parking1
        428, -- module_index: 53, name: L1_CICADA_VLoose
        435, -- module_index: 54, name: L1_CICADA_VVVVTight
        408, -- module_index: 55, name: L1_ETMHF150
        418, -- module_index: 56, name: L1_HTMHF125
        394, -- module_index: 57, name: L1_HTT360er
        499, -- module_index: 58, name: L1_BPTX_AND_Ref3_VME
        502, -- module_index: 59, name: L1_BPTX_BeamGas_Ref2_VME
        481, -- module_index: 60, name: L1_BptxMinus
        479, -- module_index: 61, name: L1_BptxXOR
        480, -- module_index: 62, name: L1_BptxPlus
        483, -- module_index: 63, name: L1_UnpairedBunchBptxMinus
    others => 0
);
