...
cond_invariant_mass_i426_i: entity work.correlation_conditions
    generic map(
-- obj cuts
        pt_threshold_obj1 => X"0046",
        pt_threshold_obj2 => X"0046",
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        calo_obj2 => bx_data.jet(2),
        mass_inv_pt => jet_jet_bx_0_bx_0_mass_inv_pt,
        condition_o => invariant_mass_i426
    );

cond_invariant_mass_i427_i: entity work.correlation_conditions
    generic map(
-- obj cuts
        pt_threshold_obj1 => X"0046",
        pt_threshold_obj2 => X"0046",
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        calo_obj2 => bx_data.jet(2),
        mass_inv_pt => jet_jet_bx_0_bx_0_mass_inv_pt,
        condition_o => invariant_mass_i427
    );

cond_invariant_mass_i428_i: entity work.correlation_conditions
    generic map(
-- obj cuts
        pt_threshold_obj1 => X"0046",
        pt_threshold_obj2 => X"0046",
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        calo_obj2 => bx_data.jet(2),
        mass_inv_pt => jet_jet_bx_0_bx_0_mass_inv_pt,
        condition_o => invariant_mass_i428
    );

cond_invariant_mass_i431_i: entity work.correlation_conditions
    generic map(
-- obj cuts
        pt_threshold_obj1 => X"0046",
        pt_threshold_obj2 => X"0046",
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        calo_obj2 => bx_data.jet(2),
        mass_inv_pt => jet_jet_bx_0_bx_0_mass_inv_pt,
        condition_o => invariant_mass_i431
    );
...
cond_cicada_trigger_i425: entity work.cicada_condition
    generic map(
        cscore => X"9100"
    )
    port map(
        lhc_clk => lhc_clk,
        cicada_i => bx_data.cicada(2),
        c_comp_o => cicada_trigger_i425
    );

cond_cicada_trigger_i477: entity work.cicada_condition
    generic map(
        cscore => X"535A"
    )
    port map(
...
-- 260 L1_CICADA_Parking1 : CICADA[CICADA-CSCORE_83p35]
l1_cicada_parking1 <= cicada_trigger_i477;
algo(52) <= l1_cicada_parking1;
...
l1_double_jet_110_35_double_jet35_mass_min1000 <= double_jet_i340 and invariant_mass_i426;
...
l1_double_jet_110_35_double_jet35_mass_min1100 <= double_jet_i340 and invariant_mass_i427;
...
l1_double_jet_110_35_double_jet35_mass_min1200 <= double_jet_i340 and invariant_mass_i428;
...
l1_double_jet_65_35_double_jet35_mass_min750_double_jet_central50 <= double_jet_i347 and invariant_mass_i431 and ( ( quad_jet_i349 ) or ( triple_jet_i350 and ( single_jet_i351 or single_jet_i352 ) ) or ( triple_jet_i353 and ( single_jet_i354 or single_jet_i355 ) ) or ( triple_jet_i356 and ( single_jet_i357 or single_jet_i358 ) ) or ( double_jet_i359 and ( double_jet_i360 or double_jet_i361 or double_jet_i362 or double_jet_i363 ) ) or ( double_jet_i364 and ( double_jet_i365 or double_jet_i366 or double_jet_i367 or double_jet_i368 ) ) );
...
l1_double_jet_65_35_double_jet35_mass_min950_double_jet_central50 <= double_jet_i347 and invariant_mass_i432 and ( ( quad_jet_i349 ) or ( triple_jet_i350 and ( single_jet_i351 or single_jet_i352 ) ) or ( triple_jet_i353 and ( single_jet_i354 or single_jet_i355 ) ) or ( triple_jet_i356 and ( single_jet_i357 or single_jet_i358 ) ) or ( double_jet_i359 and ( double_jet_i360 or double_jet_i361 or double_jet_i362 or double_jet_i363 ) ) or ( double_jet_i364 and ( double_jet_i365 or double_jet_i366 or double_jet_i367 or double_jet_i368 ) ) );
...
l1_double_jet45_mass_min700_loose_iso_eg20er2p1_rm_ovlp_d_r0p2 <= invariant_mass_ov_rm_i433;
...
l1_double_jet_85_35_double_jet35_mass_min700_mu3_oq <= double_jet_i370 and invariant_mass_i435 and single_mu_i371;
...
l1_double_jet_85_35_double_jet35_mass_min900_mu3_oq <= double_jet_i370 and invariant_mass_i436 and single_mu_i371;
...
l1_double_jet_70_35_double_jet35_mass_min700_etmhf65 <= double_jet_i372 and invariant_mass_i435 and single_etmhf_i374;
...
-- 428 L1_CICADA_VLoose : CICADA[CICADA-CSCORE_63]
l1_cicada_v_loose <= cicada_trigger_i408;
algo(53) <= l1_cicada_v_loose;

-- 435 L1_CICADA_VVVVTight : CICADA[CICADA-CSCORE_145]
l1_cicada_vvvv_tight <= cicada_trigger_i425;
algo(54) <= l1_cicada_vvvv_tight;
