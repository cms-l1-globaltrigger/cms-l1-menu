...
cond_double_jet_i493_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"005A", X"005A", X"0000", X"0000"),
        nr_eta_windows_obj1 => (1, 1, 0, 0),
        eta_w1_upper_limits_obj1 => (X"0039", X"0039", X"0000", X"0000"),
        eta_w1_lower_limits_obj1 => (X"00C6", X"00C6", X"0000", X"0000"),
-- number of objects and type
...
cond_quad_jet_i481_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_double_tau_ov_rm_i437_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i437
    );
...
cond_calo_calo_correlation_i468_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i468
    );

cond_invariant_mass_ov_rm_i429_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => invariant_mass_ov_rm_i429
    );
...
cond_cicada_trigger_i424: entity work.cicada_condition
    generic map(
        cscore => X"8540"
    )
    port map(
...
-- 77 L1_SingleEG23er2p5 : EG23[EG-ETA_2p52]
l1_single_eg23er2p5 <= single_eg_i85;
algo(33) <= l1_single_eg23er2p5;
...
algo(75) <= l1_two_mu_shower_loose;
...
l1_single_eg18er2p5 <= single_eg_i473;
algo(46) <= l1_single_eg18er2p5;

-- 172 L1_SingleEG20er2p5 : EG20[EG-ETA_2p52]
l1_single_eg20er2p5 <= single_eg_i86;
algo(37) <= l1_single_eg20er2p5;
...
l1_double_eg17_er1p5_d_eta_max1p5 <= calo_calo_correlation_i468;
algo(9) <= l1_double_eg17_er1p5_d_eta_max1p5;
...
l1_double_tau_iso34_iso26_er2p1_jet55_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i437;
algo(7) <= l1_double_tau_iso34_iso26_er2p1_jet55_rm_ovlp_d_r0p5;

-- 274 L1_DoubleJet35er2p5 : comb{JET35[JET-ETA_2p52],JET35[JET-ETA_2p52]}
l1_double_jet35er2p5 <= double_jet_i106;
algo(3) <= l1_double_jet35er2p5;

-- 275 L1_DoubleJet45er2p5 : comb{JET45[JET-ETA_2p52],JET45[JET-ETA_2p52]}
l1_double_jet45er2p5 <= double_jet_i493;
algo(23) <= l1_double_jet45er2p5;

-- 283 L1_QuadJet15er2p5 : comb{JET15[JET-ETA_2p52],JET15[JET-ETA_2p52],JET15[JET-ETA_2p52],JET15[JET-ETA_2p52]}
l1_quad_jet15er2p5 <= quad_jet_i481;
algo(5) <= l1_quad_jet15er2p5;
...
l1_double_jet45_mass_min700_iso_tau45er2p1_rm_ovlp_d_r0p5 <= invariant_mass_ov_rm_i429;
...
algo(71) <= l1_bptx_beam_gas_ref1_vme;
