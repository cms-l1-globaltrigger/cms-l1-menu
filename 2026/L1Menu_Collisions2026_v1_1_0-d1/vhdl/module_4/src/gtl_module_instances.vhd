...
cond_double_jet_i487_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_double_tau_i474_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_single_mu_i413_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
        pt_thresholds_obj1 => (X"002D", X"0000", X"0000", X"0000"),
...
cond_calo_calo_correlation_i466_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i466
    );
...
cond_cicada_trigger_i478: entity work.cicada_condition
    generic map(
        cscore => X"5600"
    )
    port map(
...
l1_single_mu22_bmtf_neg <= single_mu_i418;
algo(57) <= l1_single_mu22_bmtf_neg;

-- 48 L1_SingleMu22_OMTF_POS : MU22[MU-INDEX_OMTF_POS,MU-QLTY_SNGL]
l1_single_mu22_omtf_pos <= single_mu_i413;
algo(58) <= l1_single_mu22_omtf_pos;

-- 61 L1_DoubleMu8_SQ : comb{MU8[MU-QLTY_SNGL],MU8[MU-QLTY_SNGL]}
l1_double_mu8_sq <= double_mu_i34;
algo(54) <= l1_double_mu8_sq;
...
algo(26) <= l1_double_mu0_upt5_upt5;
...
algo(27) <= l1_double_mu0_upt8_sq_er2p0;
...
algo(42) <= l1_single_iso_eg32er2p1;

-- 222 L1_DoubleEG17_11_er1p2_dR_Max0p6 : dist{EG17[EG-ETA_1p22],EG11[EG-ETA_1p22]}[DR_0p6]
l1_double_eg17_11_er1p2_d_r_max0p6 <= calo_calo_correlation_i466;
...
algo(14) <= l1_double_eg_loose_iso20_loose_iso12_er1p5;
...
l1_cicada_parking2 <= cicada_trigger_i478;
algo(65) <= l1_cicada_parking2;

-- 265 L1_DoubleIsoTau26er2p1 : comb{TAU26[TAU-ETA_2p13,TAU-ISO_0xE],TAU26[TAU-ETA_2p13,TAU-ISO_0xE]}
l1_double_iso_tau26er2p1 <= double_tau_i474;
algo(15) <= l1_double_iso_tau26er2p1;
...
algo(16) <= l1_double_iso_tau32er2p1;
...
algo(29) <= l1_single_jet60_fwd2p5;
...
-- 327 L1_DoubleJet30er2p5 : comb{JET30[JET-ETA_2p52],JET30[JET-ETA_2p52]}
l1_double_jet30er2p5 <= double_jet_i487;
algo(25) <= l1_double_jet30er2p5;
