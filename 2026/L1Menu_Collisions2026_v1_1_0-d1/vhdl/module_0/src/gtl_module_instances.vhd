...
cond_double_jet_i488_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"0028", X"0028", X"0000", X"0000"),
        nr_eta_windows_obj1 => (1, 1, 0, 0),
        eta_w1_upper_limits_obj1 => (X"0039", X"0039", X"0000", X"0000"),
        eta_w1_lower_limits_obj1 => (X"00C6", X"00C6", X"0000", X"0000"),
-- number of objects and type
...
cond_quad_jet_i482_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_single_eg_i451_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_triple_jet_i491_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
        slice_3_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"0032", X"0032", X"0032", X"0000"),
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => triple_jet_i491
    );

cond_triple_jet_i492_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
        slice_3_high_obj1 => 11,
-- object cuts
        pt_thresholds_obj1 => (X"0046", X"0046", X"0046", X"0000"),
        nr_eta_windows_obj1 => (1, 1, 1, 0),
        eta_w1_upper_limits_obj1 => (X"0039", X"0039", X"0039", X"0000"),
        eta_w1_lower_limits_obj1 => (X"00C6", X"00C6", X"00C6", X"0000"),
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => triple_jet_i492
    );

cond_double_tau_ov_rm_i470_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i470
    );
...
cond_single_htt_i475_i: entity work.esums_conditions
    generic map(
        et_threshold => X"00C8",
        obj_type => HTT_TYPE
    )
    port map(
        lhc_clk,
        bx_data.htt(2),
        condition_o => single_htt_i475
    );

cond_single_htt_i476_i: entity work.esums_conditions
    generic map(
        et_threshold => X"00A0",
        obj_type => HTT_TYPE
    )
    port map(
        lhc_clk,
        bx_data.htt(2),
        condition_o => single_htt_i476
    );

cond_calo_calo_correlation_i421_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i421
    );

cond_calo_calo_correlation_i467_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        calo_obj2 => bx_data.eg(2),
        deta => eg_eg_bx_0_bx_0_deta,
        condition_o => calo_calo_correlation_i467
    );
...
cond_invariant_mass_ov_rm_i430_i: entity work.correlation_conditions
    generic map(
-- obj cuts
        pt_threshold_obj1 => X"005A",
        pt_threshold_obj2 => X"005A",
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        dr_orm => jet_tau_bx_0_bx_0_dr,
        mass_inv_pt => jet_jet_bx_0_bx_0_mass_inv_pt,
        condition_o => invariant_mass_ov_rm_i430
    );
...
cond_cicada_trigger_i423: entity work.cicada_condition
    generic map(
        cscore => X"7E00"
    )
    port map(
        lhc_clk => lhc_clk,
        cicada_i => bx_data.cicada(2),
        c_comp_o => cicada_trigger_i423
    );

cond_cicada_trigger_i479: entity work.cicada_condition
    generic map(
        cscore => X"5F00"
    )
    port map(
...
algo(56) <= l1_single_mu_cosmics_omtf;
...
algo(12) <= l1_double_mu0er1p5_sq_os_d_eta_max1p2;
...
algo(23) <= l1_single_loose_iso_eg28_fwd2p5;
...
l1_double_eg15_11_er1p2_d_r_max0p6 <= calo_calo_correlation_i421;
...
l1_double_eg16_er1p5_d_eta_max1p5 <= calo_calo_correlation_i467;
...
algo(18) <= l1_double_eg_loose_iso18_loose_iso12_er1p5;
...
-- 262 L1_CICADA_Parking3 : CICADA[CICADA-CSCORE_95]
l1_cicada_parking3 <= cicada_trigger_i479;
algo(69) <= l1_cicada_parking3;
...
algo(20) <= l1_double_iso_tau30er2p1;
...
algo(21) <= l1_double_iso_tau35er2p1;
...
l1_double_tau_iso34_iso23_er2p1_jet55_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i470;
...
l1_quad_jet20er2p5 <= quad_jet_i482;
...
-- 323 L1_TripleJet25er2p5 : comb{JET25[JET-ETA_2p52],JET25[JET-ETA_2p52],JET25[JET-ETA_2p52]}
l1_triple_jet25er2p5 <= triple_jet_i491;
algo(16) <= l1_triple_jet25er2p5;

-- 325 L1_TripleJet35er2p5 : comb{JET35[JET-ETA_2p52],JET35[JET-ETA_2p52],JET35[JET-ETA_2p52]}
l1_triple_jet35er2p5 <= triple_jet_i492;
algo(17) <= l1_triple_jet35er2p5;

-- 326 L1_DoubleJet20er2p5 : comb{JET20[JET-ETA_2p52],JET20[JET-ETA_2p52]}
l1_double_jet20er2p5 <= double_jet_i488;
algo(28) <= l1_double_jet20er2p5;

-- 334 L1_HTT80er : HTT80
l1_htt80er <= single_htt_i476;
algo(74) <= l1_htt80er;

-- 335 L1_HTT100er : HTT100
l1_htt100er <= single_htt_i475;
algo(73) <= l1_htt100er;
...
l1_double_jet45_mass_min800_iso_tau45er2p1_rm_ovlp_d_r0p5 <= invariant_mass_ov_rm_i430;
...
algo(68) <= l1_cicada_loose;

-- 433 L1_CICADA_VVTight : CICADA[CICADA-CSCORE_126]
l1_cicada_vv_tight <= cicada_trigger_i423;
algo(70) <= l1_cicada_vv_tight;

-- 456 L1_SingleJet8er2p13 : JET8[JET-ETA_2p13]
l1_single_jet8er2p13 <= single_jet_i448;
algo(55) <= l1_single_jet8er2p13;

-- 461 L1_SingleEG5er1p52 : EG5[EG-ETA_1p52_HASHFIX]
l1_single_eg5er1p52 <= single_eg_i451;
