...
--
cond_double_eg_i453_i: entity work.comb_conditions
    generic map(
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_eg_i453
    );

cond_double_eg_i454_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => double_eg_i454
    );

cond_double_eg_i455_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => double_eg_i455
    );

cond_double_eg_i456_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => double_eg_i456
    );

cond_double_eg_i457_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => double_eg_i457
    );

cond_double_eg_i458_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_quad_jet_i483_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => quad_jet_i483
    );

cond_single_eg_i449_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => single_eg_i449
    );

cond_single_eg_i450_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => single_eg_i450
    );

cond_single_eg_i494_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_single_jet_i439_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => single_jet_i439
    );

cond_single_jet_i440_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => single_jet_i440
    );

cond_single_jet_i441_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => single_jet_i441
    );

cond_single_jet_i442_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => single_jet_i442
    );

cond_single_jet_i443_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_single_jet_i460_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.jet(2),
        condition_o => single_jet_i460
    );

cond_single_jet_i472_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_double_tau_ov_rm_i471_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_tau_ov_rm_i471
    );
...
cond_calo_calo_correlation_i465_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i465
    );
...
cond_single_mbt1_hfm_i496_i: entity work.min_bias_hf_conditions
    generic map(
    ...
    port map(
        lhc_clk,
        bx_data.mbt1hfm(2),
        condition_o => single_mbt1_hfm_i496
    );
...
cond_single_mbt1_hfp_i495_i: entity work.min_bias_hf_conditions
    generic map(
    ...
    port map(
        lhc_clk,
        bx_data.mbt1hfp(2),
        condition_o => single_mbt1_hfp_i495
    );

cond_axol1tl_trigger_i497: entity work.ml_comparison
    generic map(2016, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i497
    );

cond_axol1tl_trigger_i498: entity work.ml_comparison
    generic map(2335, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i498
    );

cond_axol1tl_trigger_i499: entity work.ml_comparison
    generic map(2717, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i499
    );

cond_axol1tl_trigger_i500: entity work.ml_comparison
    generic map(3103, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i500
    );

cond_axol1tl_trigger_i501: entity work.ml_comparison
    generic map(7500, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i501
    );

cond_axol1tl_trigger_i502: entity work.ml_comparison
    generic map(10338, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i502
    );

cond_axol1tl_trigger_i503: entity work.ml_comparison
    generic map(10000000, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v6_score,
        axol1tl_trigger_i503
    );
...
algo(110) <= l1_mu3er1p5_jet100er2p5_etmhf30;
...
algo(112) <= l1_mu3er1p5_jet100er2p5_etmhf40;
...
algo(115) <= l1_mu3er1p5_jet100er2p5_etmhf50;
...
algo(53) <= l1_double_mu3_sq_etmhf30_htt60er;
...
algo(69) <= l1_double_mu3_sq_etmhf50_htt60er;
...
algo(83) <= l1_double_mu3_sq_etmhf60_jet60er2p5;
...
-- 165 L1_MinimumBiasHF1_AND : MBT0HFP1 AND MBT0HFM1
l1_minimum_bias_hf1_and <= single_mbt0_hfp_i302 and single_mbt0_hfm_i303;
algo(51) <= l1_minimum_bias_hf1_and;

-- 166 L1_MinimumBiasHF1_OR : MBT0HFP1 OR MBT0HFM1
l1_minimum_bias_hf1_or <= single_mbt0_hfp_i302 or single_mbt0_hfm_i303;
algo(59) <= l1_minimum_bias_hf1_or;

-- 167 L1_MinimumBiasHF1_OR_BptxAND : (MBT0HFP1 OR MBT0HFM1) AND EXT_ZeroBias_BPTX_AND_VME
l1_minimum_bias_hf1_or_bptx_and <= ( single_mbt0_hfp_i302 or single_mbt0_hfm_i303 ) and single_ext_i301;
algo(63) <= l1_minimum_bias_hf1_or_bptx_and;

-- 168 L1_MinimumBiasHF1_AND_BptxAND : (MBT0HFP1 AND MBT0HFM1) AND EXT_ZeroBias_BPTX_AND_VME
l1_minimum_bias_hf1_and_bptx_and <= ( single_mbt0_hfp_i302 and single_mbt0_hfm_i303 ) and single_ext_i301;
algo(57) <= l1_minimum_bias_hf1_and_bptx_and;

-- 169 L1_MinimumBiasHF2_AND : MBT1HFP1 AND MBT1HFM1
l1_minimum_bias_hf2_and <= single_mbt1_hfp_i495 and single_mbt1_hfm_i496;
algo(66) <= l1_minimum_bias_hf2_and;

-- 170 L1_MinimumBiasHF2_OR : MBT1HFP1 OR MBT1HFM1
l1_minimum_bias_hf2_or <= single_mbt1_hfp_i495 or single_mbt1_hfm_i496;
algo(77) <= l1_minimum_bias_hf2_or;

-- 221 L1_DoubleEG16_11_er1p2_dR_Max0p6 : dist{EG16[EG-ETA_1p22],EG11[EG-ETA_1p22]}[DR_0p6]
l1_double_eg16_11_er1p2_d_r_max0p6 <= calo_calo_correlation_i465;
algo(9) <= l1_double_eg16_11_er1p2_d_r_max0p6;

-- 246 L1_SingleJet60_BptxAND : JET60 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet60_bptx_and <= single_jet_i218 and single_ext_i301;
algo(103) <= l1_single_jet60_bptx_and;

-- 247 L1_SingleJet90_BptxAND : JET90 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet90_bptx_and <= single_jet_i219 and single_ext_i301;
algo(19) <= l1_single_jet90_bptx_and;

-- 251 L1_MinimumBiasHF2_AND_BptxAND : (MBT1HFP1 AND MBT1HFM1) AND EXT_ZeroBias_BPTX_AND_VME
l1_minimum_bias_hf2_and_bptx_and <= ( single_mbt1_hfp_i495 and single_mbt1_hfm_i496 ) and single_ext_i301;
algo(71) <= l1_minimum_bias_hf2_and_bptx_and;

-- 252 L1_MinimumBiasHF2_OR_BptxAND : (MBT1HFP1 OR MBT1HFM1) AND EXT_ZeroBias_BPTX_AND_VME
l1_minimum_bias_hf2_or_bptx_and <= ( single_mbt1_hfp_i495 or single_mbt1_hfm_i496 ) and single_ext_i301;
algo(80) <= l1_minimum_bias_hf2_or_bptx_and;
...
l1_double_tau_iso34_iso23_er2p1_jet70_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i471;
...
l1_quad_jet24er2p5 <= quad_jet_i483;
algo(10) <= l1_quad_jet24er2p5;

-- 289 L1_SingleEG21_BptxAND : EG21 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_eg21_bptx_and <= single_eg_i494 and single_ext_i301;
algo(56) <= l1_single_eg21_bptx_and;
...
algo(91) <= l1_single_jet30er2p5_not_bptx_or;

-- 294 L1_SingleJet20er1p3to2p5_NotBptxOR : JET20[JET-ETA_1p392_2p52_NEG,JET-ETA_1p392_2p52_POS] AND ( NOT EXT_BPTX_OR_VME)
l1_single_jet20er1p3to2p5_not_bptx_or <= single_jet_i472 and ( not single_ext_i293 );
algo(67) <= l1_single_jet20er1p3to2p5_not_bptx_or;

-- 295 L1_SingleJet20er1p3_NotBptxOR : JET20[JET-ETA_1p3] AND ( NOT EXT_BPTX_OR_VME)
l1_single_jet20er1p3_not_bptx_or <= single_jet_i446 and ( not single_ext_i293 );
algo(62) <= l1_single_jet20er1p3_not_bptx_or;

-- 296 L1_SingleJet35 : JET35
l1_single_jet35 <= single_jet_i217;
algo(94) <= l1_single_jet35;

-- 297 L1_SingleJet60er1p3 : JET60[JET-ETA_1p3]
l1_single_jet60er1p3 <= single_jet_i459;
algo(106) <= l1_single_jet60er1p3;

-- 298 L1_SingleJet60er1p3to2p5 : JET60[JET-ETA_2p52] AND  NOT JET60[JET-ETA_1p3]
l1_single_jet60er1p3to2p5 <= single_jet_i130 and not single_jet_i459;
algo(108) <= l1_single_jet60er1p3to2p5;

-- 299 L1_SingleJet60er2p5to3p0 : JET60[JET-ETA_3p0] AND  NOT JET60[JET-ETA_2p52]
l1_single_jet60er2p5to3p0 <= single_jet_i460 and not single_jet_i130;
algo(109) <= l1_single_jet60er2p5to3p0;

-- 300 L1_SingleJet60er3p0to5p0 : JET60 AND  NOT JET60[JET-ETA_3p0]
l1_single_jet60er3p0to5p0 <= single_jet_i218 and not single_jet_i460;
algo(111) <= l1_single_jet60er3p0to5p0;

-- 301 L1_SingleJet60 : JET60
l1_single_jet60 <= single_jet_i218;
algo(102) <= l1_single_jet60;

-- 302 L1_SingleJet90 : JET90
l1_single_jet90 <= single_jet_i219;
algo(18) <= l1_single_jet90;
...
algo(60) <= l1_etmhf80_single_jet55er2p5_d_phi_min2p1;
...
algo(64) <= l1_etmhf80_single_jet55er2p5_d_phi_min2p6;
...
algo(78) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p1;
...
algo(82) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p6;
...
l1_double_jet45_mass_min800_loose_iso_eg20er2p1_rm_ovlp_d_r0p2 <= invariant_mass_ov_rm_i434;
...
-- 421 L1_AXO_VLoose : AXO[AXO-MODEL_v6,AXO-SCORE_VLooseNew]
l1_axo_v_loose <= axol1tl_trigger_i497;
algo(121) <= l1_axo_v_loose;

-- 422 L1_AXO_Loose : AXO[AXO-MODEL_v6,AXO-SCORE_LooseNew]
l1_axo_loose <= axol1tl_trigger_i498;
algo(118) <= l1_axo_loose;

-- 423 L1_AXO_Medium : AXO[AXO-MODEL_v6,AXO-SCORE_MediumNew]
l1_axo_medium <= axol1tl_trigger_i499;
algo(119) <= l1_axo_medium;

-- 424 L1_AXO_Tight : AXO[AXO-MODEL_v6,AXO-SCORE_TightNew]
l1_axo_tight <= axol1tl_trigger_i500;
algo(120) <= l1_axo_tight;

-- 425 L1_AXO_VTight : AXO[AXO-MODEL_v6,AXO-SCORE_VTightNew]
l1_axo_v_tight <= axol1tl_trigger_i501;
algo(122) <= l1_axo_v_tight;

-- 426 L1_AXO_VVTight : AXO[AXO-MODEL_v6,AXO-SCORE_VVTightNew]
l1_axo_vv_tight <= axol1tl_trigger_i502;
algo(123) <= l1_axo_vv_tight;

-- 427 L1_AXO_VVVTight : AXO[AXO-MODEL_v6,AXO-SCORE_VVVTight]
l1_axo_vvv_tight <= axol1tl_trigger_i503;
algo(124) <= l1_axo_vvv_tight;
...
algo(76) <= l1_single_jet20er2p5_not_bptx_or_3_bx;
...
algo(98) <= l1_single_jet43er2p5_not_bptx_or_3_bx;
...
algo(100) <= l1_single_jet46er2p5_not_bptx_or_3_bx;

-- 443 L1_SingleJet35_BptxAND : JET35 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet35_bptx_and <= single_jet_i217 and single_ext_i301;
algo(97) <= l1_single_jet35_bptx_and;

-- 444 L1_SingleJet8_BptxAND : JET8 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet8_bptx_and <= single_jet_i438 and single_ext_i301;
algo(117) <= l1_single_jet8_bptx_and;

-- 445 L1_SingleJet12_BptxAND : JET12 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet12_bptx_and <= single_jet_i439 and single_ext_i301;
algo(32) <= l1_single_jet12_bptx_and;

-- 446 L1_SingleJet16_BptxAND : JET16 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet16_bptx_and <= single_jet_i440 and single_ext_i301;
algo(42) <= l1_single_jet16_bptx_and;

-- 447 L1_SingleJet20_BptxAND : JET20 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet20_bptx_and <= single_jet_i441 and single_ext_i301;
algo(54) <= l1_single_jet20_bptx_and;

-- 448 L1_SingleJet24_BptxAND : JET24 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet24_bptx_and <= single_jet_i442 and single_ext_i301;
algo(85) <= l1_single_jet24_bptx_and;

-- 449 L1_SingleJet8er1p3_BptxAND : JET8[JET-ETA_1p3] AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet8er1p3_bptx_and <= single_jet_i443 and single_ext_i301;
algo(17) <= l1_single_jet8er1p3_bptx_and;

-- 450 L1_SingleJet12er1p3_BptxAND : JET12[JET-ETA_1p3] AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet12er1p3_bptx_and <= single_jet_i444 and single_ext_i301;
algo(35) <= l1_single_jet12er1p3_bptx_and;

-- 451 L1_SingleJet16er1p3_BptxAND : JET16[JET-ETA_1p3] AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet16er1p3_bptx_and <= single_jet_i445 and single_ext_i301;
algo(44) <= l1_single_jet16er1p3_bptx_and;

-- 452 L1_SingleJet20er1p3_BptxAND : JET20[JET-ETA_1p3] AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet20er1p3_bptx_and <= single_jet_i446 and single_ext_i301;
algo(58) <= l1_single_jet20er1p3_bptx_and;

-- 453 L1_SingleJet24er1p3_BptxAND : JET24[JET-ETA_1p3] AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet24er1p3_bptx_and <= single_jet_i447 and single_ext_i301;
algo(88) <= l1_single_jet24er1p3_bptx_and;

-- 454 L1_SingleJet8 : JET8
l1_single_jet8 <= single_jet_i438;
algo(116) <= l1_single_jet8;

-- 455 L1_SingleJet8er1p3 : JET8[JET-ETA_1p3]
l1_single_jet8er1p3 <= single_jet_i443;
algo(16) <= l1_single_jet8er1p3;

-- 457 L1_SingleEG5_BptxAND : EG5 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_eg5_bptx_and <= single_eg_i449 and single_ext_i301;
algo(101) <= l1_single_eg5_bptx_and;

-- 458 L1_SingleEG7_BptxAND : EG7 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_eg7_bptx_and <= single_eg_i450 and single_ext_i301;
algo(105) <= l1_single_eg7_bptx_and;

-- 459 L1_SingleEG5 : EG5
l1_single_eg5 <= single_eg_i449;
algo(99) <= l1_single_eg5;

-- 460 L1_SingleEG7 : EG7
l1_single_eg7 <= single_eg_i450;
algo(104) <= l1_single_eg7;

-- 463 L1_DoubleEG2_BptxAND : comb{EG2,EG2} AND EXT_ZeroBias_BPTX_AND_VME
l1_double_eg2_bptx_and <= double_eg_i453 and single_ext_i301;
algo(75) <= l1_double_eg2_bptx_and;

-- 464 L1_DoubleEG2er2p13_BptxAND : comb{EG2[EG-ETA_2p13],EG2[EG-ETA_2p13]} AND EXT_ZeroBias_BPTX_AND_VME
l1_double_eg2er2p13_bptx_and <= double_eg_i454 and single_ext_i301;
algo(84) <= l1_double_eg2er2p13_bptx_and;

-- 465 L1_DoubleEG3_BptxAND : comb{EG3,EG3} AND EXT_ZeroBias_BPTX_AND_VME
l1_double_eg3_bptx_and <= double_eg_i455 and single_ext_i301;
algo(87) <= l1_double_eg3_bptx_and;

-- 466 L1_DoubleEG3er2p13_BptxAND : comb{EG3[EG-ETA_2p13],EG3[EG-ETA_2p13]} AND EXT_ZeroBias_BPTX_AND_VME
l1_double_eg3er2p13_bptx_and <= double_eg_i457 and single_ext_i301;
algo(90) <= l1_double_eg3er2p13_bptx_and;

-- 467 L1_DoubleEG4_BptxAND : comb{EG4,EG4} AND EXT_ZeroBias_BPTX_AND_VME
l1_double_eg4_bptx_and <= double_eg_i456 and single_ext_i301;
algo(93) <= l1_double_eg4_bptx_and;

-- 468 L1_DoubleEG4er2p13_BptxAND : comb{EG4[EG-ETA_2p13],EG4[EG-ETA_2p13]} AND EXT_ZeroBias_BPTX_AND_VME
l1_double_eg4er2p13_bptx_and <= double_eg_i458 and single_ext_i301;
algo(96) <= l1_double_eg4er2p13_bptx_and;

-- 469 L1_DoubleEG2 : comb{EG2,EG2}
l1_double_eg2 <= double_eg_i453;
algo(72) <= l1_double_eg2;

-- 470 L1_DoubleEG2er2p13 : comb{EG2[EG-ETA_2p13],EG2[EG-ETA_2p13]}
l1_double_eg2er2p13 <= double_eg_i454;
algo(81) <= l1_double_eg2er2p13;
...
algo(95) <= l1_first_bunch_in_train;
...
algo(89) <= l1_first_bunch_after_train;
