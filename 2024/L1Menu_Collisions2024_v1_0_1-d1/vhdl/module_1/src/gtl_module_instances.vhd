...
cond_double_mu_i420_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
        pt_thresholds_obj1 => (X"0001", X"0001", X"0000", X"0000"),
...
algo(27) <= l1_loose_iso_eg14er2p5_htt200er;
...
l1_double_iso_tau32er2p1_mass_max80 <= invariant_mass_i427;
...
algo(51) <= l1_hcal_laser_mon_veto;
