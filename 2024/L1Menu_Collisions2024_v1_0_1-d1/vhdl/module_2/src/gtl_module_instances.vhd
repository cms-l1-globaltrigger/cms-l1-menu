...
cond_muon_muon_correlation_i425_i: entity work.correlation_conditions
    generic map(
-- slices for muon
        slice_low_obj1 => 0,
        slice_high_obj1 => 7,
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        os_charcorr_double => os_charcorr_double_bx_0_bx_0,
        dr => mu_mu_bx_0_bx_0_dr,
        condition_o => muon_muon_correlation_i425
    );
...
algo(38) <= l1_single_mu_cosmics_bmtf;
...
l1_single_mu0_sq14_bmtf <= single_mu_i418;
algo(36) <= l1_single_mu0_sq14_bmtf;
...
l1_double_mu0er1p5_sq_os_d_r_max1p4 <= muon_muon_correlation_i425;
...
l1_double_mu4_sq_os_d_r_max1p2 <= muon_muon_correlation_i423;
...
l1_triple_mu_3_sq_2p5_sq_0_os_mass_max12 <= invariant_mass3_i424;
...
algo(26) <= l1_single_iso_eg32er2p5;
...
algo(47) <= l1_first_collision_in_train;

-- 483 L1_BPTX_OR_Ref3_VME : EXT_BPTX_OR_Ref3_VME
l1_bptx_or_ref3_vme <= single_ext_i340;
algo(46) <= l1_bptx_or_ref3_vme;
