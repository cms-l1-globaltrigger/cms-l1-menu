...
constant global_index: global_index_array := (
        ...
        113, -- module_index: 32, name: L1_TripleMu_5_4_2p5_DoubleMu_5_2p5_OS_Mass_5to17
         ...
         31, -- module_index: 37, name: L1_SingleMu11_SQ14_BMTF
         46, -- module_index: 38, name: L1_SingleMu22_BMTF_POS
         24, -- module_index: 39, name: L1_SingleMu5_BMTF
         29, -- module_index: 40, name: L1_SingleMu9_SQ14_BMTF
          1, -- module_index: 41, name: L1_SingleMuCosmics_BMTF
        303, -- module_index: 42, name: L1_SingleJet120
        302, -- module_index: 43, name: L1_SingleJet90
         41, -- module_index: 44, name: L1_SingleMu22_DQ
        429, -- module_index: 45, name: L1_CICADA_Loose
        428, -- module_index: 46, name: L1_CICADA_VLoose
        435, -- module_index: 47, name: L1_CICADA_VVVVTight
        408, -- module_index: 48, name: L1_ETMHF150
        418, -- module_index: 49, name: L1_HTMHF125
        394, -- module_index: 50, name: L1_HTT360er
        499, -- module_index: 51, name: L1_BPTX_AND_Ref3_VME
        502, -- module_index: 52, name: L1_BPTX_BeamGas_Ref2_VME
        481, -- module_index: 53, name: L1_BptxMinus
        480, -- module_index: 54, name: L1_BptxPlus
        479, -- module_index: 55, name: L1_BptxXOR
        483, -- module_index: 56, name: L1_UnpairedBunchBptxMinus
    others => 0
);
