...
algo(47) <= l1_single_mu_open_emtf;
...
algo(37) <= l1_single_mu0_upt10_emtf;
...
-- 432 L1_CICADA_VTight : CICADA[CICADA-CSCORE_66p25]
l1_cicada_v_tight <= cicada_trigger_i412;
algo(68) <= l1_cicada_v_tight;
