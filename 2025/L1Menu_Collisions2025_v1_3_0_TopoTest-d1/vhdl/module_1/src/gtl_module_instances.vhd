...
cond_single_jet_i467_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
cond_calo_calo_correlation_i472_i: entity work.correlation_conditions
    generic map(
-- obj cuts
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => calo_calo_correlation_i472
    );
...
cond_axol1tl_trigger_i429: entity work.ml_comparison
    generic map(44447, AXO_SCORE_WIDTH)
    port map(
        axol1tl_v5_score,
...
algo(60) <= l1_double_mu18er2p1_sq;
...
algo(53) <= l1_double_mu0_upt6_sq_er2p0;
...
algo(47) <= l1_double_mu3_sq_etmhf30_htt60er;
...
algo(15) <= l1_double_mu3_sq_etmhf40_htt60er;
...
algo(17) <= l1_double_mu3_sq_etmhf40_jet60er2p5_or_double_jet40er2p5;
...
algo(50) <= l1_double_eg_20_10_er2p5;
...
l1_double_tau_iso34_iso23_er2p1_jet70_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i478;
algo(10) <= l1_double_tau_iso34_iso23_er2p1_jet70_rm_ovlp_d_r0p5;

-- 297 L1_SingleJet60er1p3 : JET60[JET-ETA_1p3]
l1_single_jet60er1p3 <= single_jet_i466;
algo(16) <= l1_single_jet60er1p3;

-- 298 L1_SingleJet60er1p3to2p5 : JET60[JET-ETA_2p52] AND  NOT JET60[JET-ETA_1p3]
l1_single_jet60er1p3to2p5 <= single_jet_i130 and not single_jet_i466;
algo(19) <= l1_single_jet60er1p3to2p5;

-- 299 L1_SingleJet60er2p5to3p0 : JET60[JET-ETA_3p0] AND  NOT JET60[JET-ETA_2p52]
l1_single_jet60er2p5to3p0 <= single_jet_i467 and not single_jet_i130;
algo(22) <= l1_single_jet60er2p5to3p0;

-- 300 L1_SingleJet60er3p0to5p0 : JET60 AND  NOT JET60[JET-ETA_3p0]
l1_single_jet60er3p0to5p0 <= single_jet_i218 and not single_jet_i467;
algo(26) <= l1_single_jet60er3p0to5p0;
...
algo(56) <= l1_single_jet60_fwd2p5;
