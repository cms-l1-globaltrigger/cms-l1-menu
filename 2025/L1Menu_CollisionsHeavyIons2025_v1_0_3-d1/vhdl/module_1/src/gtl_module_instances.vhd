...
algo(23) <= l1_first_collision_in_orbit_centrality30_100_bptx_and;
...
algo(21) <= l1_first_collision_in_orbit_centrality50_100_bptx_and;
...
algo(38) <= l1_last_bunch_in_train_50ns;
...
algo(147) <= l1_centrality_30_100_minimum_bias_hf1_and_bptx_and;
...
algo(150) <= l1_centrality_50_100_minimum_bias_hf1_and_bptx_and;
...
algo(42) <= l1_minimum_bias_hf1plus_bptx_and;
...
algo(40) <= l1_minimum_bias_hf1minus_bptx_and;
...
algo(51) <= l1_minimum_bias_hf2plus_bptx_and;
...
algo(34) <= l1_minimum_bias_hf1_and_bptx_and;
...
algo(44) <= l1_minimum_bias_hf2_and_bptx_and;
...
algo(35) <= l1_minimum_bias_hf1_or_bptx_and;
...
algo(45) <= l1_minimum_bias_hf2_or_bptx_and;
...
algo(58) <= l1_not_minimum_bias_hf2_and_bptx_and;
...
algo(33) <= l1_single_jet8_not_minimum_bias_hf2_and_bptx_and;
...
algo(160) <= l1_single_jet12_not_minimum_bias_hf2_and_bptx_and;
...
algo(174) <= l1_single_jet16_not_minimum_bias_hf2_and_bptx_and;
...
algo(176) <= l1_single_jet20_not_minimum_bias_hf2_and_bptx_and;
...
algo(181) <= l1_single_jet24_not_minimum_bias_hf2_and_bptx_and;
...
algo(6) <= l1_single_jet28_not_minimum_bias_hf2_and_bptx_and;
...
algo(177) <= l1_double_jet8_delta_phi2p0_not_minimum_bias_hf2_bptx_and;
...
algo(169) <= l1_double_jet12_delta_phi2p0_not_minimum_bias_hf2_bptx_and;
...
algo(175) <= l1_double_jet16_delta_phi2p0_not_minimum_bias_hf2_bptx_and;
...
algo(89) <= l1_single_mu_open_not_minimum_bias_hf2_and_bptx_and;
...
algo(92) <= l1_single_mu_open_not_minimum_bias_hf2_or_bptx_and;
...
algo(70) <= l1_single_mu_cosmic_not_minimum_bias_hf2_or_bptx_and;
...
algo(96) <= l1_single_mu_open_or_single_mu_cosmic_emtf_not_minimum_bias_hf2_and_bptx_and;
...
algo(99) <= l1_single_mu_open_or_single_mu_cosmic_emtf_not_minimum_bias_hf2_or_bptx_and;
...
algo(186) <= l1_double_mu_cosmic_not_minimum_bias_hf2_and_bptx_and;
...
algo(183) <= l1_double_mu0_not_minimum_bias_hf2_and_bptx_and;
...
algo(193) <= l1_double_mu_open_not_minimum_bias_hf2_and_bptx_and;
...
algo(121) <= l1_single_eg3_not_minimum_bias_hf2_or_bptx_and;
...
algo(125) <= l1_single_eg4_not_minimum_bias_hf2_or_bptx_and;
...
algo(113) <= l1_single_eg2_not_minimum_bias_hf2_and_bptx_and;
...
algo(120) <= l1_single_eg3_not_minimum_bias_hf2_and_bptx_and;
...
algo(124) <= l1_single_eg4_not_minimum_bias_hf2_and_bptx_and;
...
algo(128) <= l1_single_eg5_not_minimum_bias_hf2_and_bptx_and;
...
algo(129) <= l1_single_eg5er1p5_not_minimum_bias_hf2_and_bptx_and;
...
algo(131) <= l1_single_eg5er2p1_not_minimum_bias_hf2_and_bptx_and;
...
algo(135) <= l1_single_eg6er2p5_not_minimum_bias_hf2_and_bptx_and;
...
algo(139) <= l1_single_eg7er2p5_not_minimum_bias_hf2_and_bptx_and;
...
algo(145) <= l1_single_eg8er2p5_not_minimum_bias_hf2_and_bptx_and;
...
algo(157) <= l1_double_eg2er1p5_delta_phi2p0_not_minimum_bias_hf2_and_bptx_and;
...
algo(159) <= l1_double_eg2er2p1_delta_phi2p0_not_minimum_bias_hf2_and_bptx_and;
...
algo(158) <= l1_double_eg2er1p5_not_minimum_bias_hf2_and_bptx_and;
...
algo(161) <= l1_double_eg2er2p1_not_minimum_bias_hf2_and_bptx_and;
...
algo(156) <= l1_double_eg2_not_minimum_bias_hf2_and_bptx_and;
...
algo(163) <= l1_double_eg3_not_minimum_bias_hf2_and_bptx_and;
...
algo(164) <= l1_double_eg4_not_minimum_bias_hf2_and_bptx_and;
...
algo(166) <= l1_double_eg5_not_minimum_bias_hf2_and_bptx_and;
...
algo(140) <= l1_centrality_0_0p5_bptx_and;
...
algo(141) <= l1_centrality_0_1_bptx_and;
...
algo(144) <= l1_centrality_30_40_bptx_and;
...
algo(148) <= l1_centrality_40_50_bptx_and;
...
algo(146) <= l1_centrality_30_50_bptx_and;
...
algo(149) <= l1_centrality_50_65_bptx_and;
...
algo(151) <= l1_centrality_65_80_bptx_and;
...
algo(152) <= l1_centrality_80_100_bptx_and;
...
algo(130) <= l1_single_eg5er2p5_bptx_and;
...
algo(137) <= l1_single_eg7er2p5_bptx_and;
...
algo(76) <= l1_single_eg10er2p5_bptx_and;
...
algo(88) <= l1_single_eg15er2p5_bptx_and;
...
algo(97) <= l1_single_eg18er2p5_bptx_and;
...
algo(106) <= l1_single_eg21er2p5_bptx_and;
...
algo(127) <= l1_single_eg5er2p1_bptx_and;
...
algo(136) <= l1_single_eg7er2p1_bptx_and;
...
algo(73) <= l1_single_eg10er2p1_bptx_and;
...
algo(83) <= l1_single_eg15er2p1_bptx_and;
...
algo(95) <= l1_single_eg18er2p1_bptx_and;
...
algo(155) <= l1_double_eg2_bptx_and;
...
algo(162) <= l1_double_eg5_bptx_and;
...
algo(154) <= l1_double_eg10_bptx_and;
...
algo(171) <= l1_single_jet16_fwd_bptx_and;
...
algo(4) <= l1_single_jet28_fwd_bptx_and;
...
algo(9) <= l1_single_jet36_fwd_bptx_and;
...
algo(22) <= l1_single_jet56_fwd_bptx_and;
...
algo(28) <= l1_single_jet64_fwd_bptx_and;

-- 385 L1_SingleJet28_DMeson_BptxAND : JET28 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet28_d_meson_bptx_and <= single_jet_i57 and single_ext_i0;
algo(2) <= l1_single_jet28_d_meson_bptx_and;

-- 386 L1_SingleJet44_DMeson_BptxAND : JET44 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet44_d_meson_bptx_and <= single_jet_i61 and single_ext_i0;
algo(13) <= l1_single_jet44_d_meson_bptx_and;

-- 387 L1_SingleJet60_DMeson_BptxAND : JET60 AND EXT_ZeroBias_BPTX_AND_VME
l1_single_jet60_d_meson_bptx_and <= single_jet_i46 and single_ext_i0;
algo(26) <= l1_single_jet60_d_meson_bptx_and;
...
algo(108) <= l1_single_mu_open_er1p1_not_bptx_or_3_bx;
...
algo(110) <= l1_single_mu_open_er1p4_not_bptx_or_3_bx;
...
algo(65) <= l1_single_mu_cosmic_bptx_and;
...
algo(79) <= l1_single_mu_open_bptx_and;
...
algo(53) <= l1_single_mu3_bptx_and;
...
algo(60) <= l1_single_mu5_bptx_and;
...
algo(64) <= l1_single_mu7_bptx_and;
...
algo(82) <= l1_single_mu_open_centrality_30_100_bptx_and;
...
algo(84) <= l1_single_mu_open_centrality_40_100_bptx_and;
...
algo(85) <= l1_single_mu_open_centrality_50_100_bptx_and;
...
algo(91) <= l1_single_mu_open_or_single_mu_cosmic_emtf_bptx_and;
...
algo(55) <= l1_single_mu3_single_eg12_bptx_and;
...
algo(94) <= l1_single_mu_open_single_jet28_mid_eta2p7_bptx_and;
...
algo(98) <= l1_single_mu_open_single_jet44_mid_eta2p7_bptx_and;
...
algo(102) <= l1_single_mu_open_single_jet56_mid_eta2p7_bptx_and;
...
algo(104) <= l1_single_mu_open_single_jet64_mid_eta2p7_bptx_and;
...
algo(56) <= l1_single_mu3_single_jet28_mid_eta2p7_bptx_and;
...
algo(54) <= l1_single_mu3_single_jet32_mid_eta2p7_bptx_and;
...
algo(57) <= l1_single_mu3_single_jet40_mid_eta2p7_bptx_and;
...
algo(111) <= l1_single_mu_shower_nominal_bptx_and;
...
algo(47) <= l1_single_mu0_centrality_30_100_bptx_and;
...
algo(49) <= l1_single_mu0_centrality_40_100_bptx_and;
...
algo(182) <= l1_double_mu0_bptx_and;
...
algo(187) <= l1_double_mu_open_bptx_and;
...
algo(188) <= l1_double_mu_open_centrality_30_100_bptx_and;
...
algo(190) <= l1_double_mu_open_centrality_40_100_bptx_and;
...
algo(191) <= l1_double_mu_open_centrality_50_100_bptx_and;
...
algo(192) <= l1_double_mu_open_os_bptx_and;
...
algo(1) <= l1_double_mu_open_ss_bptx_and;
...
algo(3) <= l1_double_mu_sq_bptx_and;
...
algo(5) <= l1_double_mu_sq_max_dr3p5_bptx_and;
