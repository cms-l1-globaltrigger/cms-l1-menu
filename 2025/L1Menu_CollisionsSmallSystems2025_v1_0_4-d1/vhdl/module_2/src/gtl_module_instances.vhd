...
-- External condition assignment
single_ext_i128 <= bx_data.ext_cond(2)(35); -- EXT_HCAL_LaserMon_4
-- External condition assignment
...
l1_hcal_laser_mon_veto <= single_ext_i128;
algo(23) <= l1_hcal_laser_mon_veto;

-- 33 L1_HTT120er : HTT120
l1_htt120er <= single_htt_i129;
algo(17) <= l1_htt120er;

-- 36 L1_HTT255er : HTT255
l1_htt255er <= single_htt_i132;
algo(18) <= l1_htt255er;

-- 40 L1_HTT400er : HTT400
l1_htt400er <= single_htt_i136;
algo(19) <= l1_htt400er;

-- 52 L1_SingleJet32 : JET32
l1_single_jet32 <= single_jet_i103;
algo(14) <= l1_single_jet32;

-- 58 L1_SingleJet56 : JET56
l1_single_jet56 <= single_jet_i108;
algo(15) <= l1_single_jet56;

-- 66 L1_SingleJet160 : JET160
l1_single_jet160 <= single_jet_i115;
algo(13) <= l1_single_jet160;

-- 69 L1_SingleJet140er2p5 : JET140[JET-ETA_2p52]
l1_single_jet140er2p5 <= single_jet_i162;
algo(4) <= l1_single_jet140er2p5;

-- 93 L1_SingleIsoEG20 : EG20[EG-ISO_0xA]
l1_single_iso_eg20 <= single_eg_i85;
algo(6) <= l1_single_iso_eg20;
