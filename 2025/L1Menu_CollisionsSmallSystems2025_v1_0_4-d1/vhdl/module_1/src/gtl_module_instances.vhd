...
cond_double_mu_i125_i: entity work.comb_conditions
    generic map(
...
-- number of objects and type
    ...
    port map(
        ...
        condition_o => double_mu_i125
    );

cond_single_mu_i165_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
...
cond_single_ett_i126_i: entity work.esums_conditions
    generic map(
        et_threshold => X"0FA0",
        obj_type => ETT_TYPE
    )
...
-- External condition assignment
single_ext_i127 <= bx_data.ext_cond(2)(32); -- EXT_HCAL_LaserMon_1
-- External condition assignment
...
-- 415 L1_SingleJet200 : JET200
l1_single_jet200 <= single_jet_i251;
