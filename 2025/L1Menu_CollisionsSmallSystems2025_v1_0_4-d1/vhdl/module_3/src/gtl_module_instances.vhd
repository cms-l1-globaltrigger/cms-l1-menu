...
cond_single_mu_i164_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_muon => bx_data. mu(2),
        condition_o => single_mu_i164
    );

cond_single_mu_i182_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
...
cond_single_mu_i192_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
...
algo(20) <= l1_bptx_beam_gas_b1_vme;
