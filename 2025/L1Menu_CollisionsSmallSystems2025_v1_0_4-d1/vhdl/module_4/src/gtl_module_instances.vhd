...
cond_quad_jet_i138_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_triple_eg_i169_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
        slice_2_high_obj1 => 11,
...
cond_triple_mu_i170_i: entity work.comb_conditions
    generic map(
-- no slice requirements
-- object cuts
...
cond_muon_muon_correlation_i191_i: entity work.correlation_conditions
    generic map(
-- slices for muon
        slice_low_obj1 => 0,
        slice_high_obj1 => 7,
...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        condition_o => muon_muon_correlation_i191
    );
...
l1_htt160er <= single_htt_i130;
algo(56) <= l1_htt160er;

-- 38 L1_HTT320er : HTT320
l1_htt320er <= single_htt_i134;
algo(57) <= l1_htt320er;

-- 56 L1_SingleJet48 : JET48
l1_single_jet48 <= single_jet_i106;
algo(53) <= l1_single_jet48;

-- 64 L1_SingleJet140 : JET140
l1_single_jet140 <= single_jet_i113;
algo(51) <= l1_single_jet140;

-- 68 L1_SingleJet180 : JET180
l1_single_jet180 <= single_jet_i117;
algo(52) <= l1_single_jet180;

-- 71 L1_SingleJet8erHE : JET8[JET-ETA_1p392_2p958_NEG,JET-ETA_1p392_2p958_POS]
l1_single_jet8er_he <= single_jet_i171;
algo(19) <= l1_single_jet8er_he;

-- 72 L1_SingleJet10erHE : JET10[JET-ETA_1p392_2p958_NEG,JET-ETA_1p392_2p958_POS]
l1_single_jet10er_he <= single_jet_i160;
algo(17) <= l1_single_jet10er_he;

-- 73 L1_SingleJet12erHE : JET12[JET-ETA_1p392_2p958_NEG,JET-ETA_1p392_2p958_POS]
l1_single_jet12er_he <= single_jet_i161;
...
algo(47) <= l1_single_iso_eg38;

-- 106 L1_SingleIsoEG24er2p1 : EG24[EG-ETA_2p13,EG-ISO_0xA]
l1_single_iso_eg24er2p1 <= single_eg_i150;
...
l1_double_eg_22_10_er2p5 <= double_eg_i118;
algo(3) <= l1_double_eg_22_10_er2p5;

-- 160 L1_DoubleEG_25_12_er2p5 : comb{EG25[EG-ETA_2p52],EG12[EG-ETA_2p52]}
l1_double_eg_25_12_er2p5 <= double_eg_i120;
algo(4) <= l1_double_eg_25_12_er2p5;

-- 161 L1_DoubleEG_25_14_er2p5 : comb{EG25[EG-ETA_2p52],EG14[EG-ETA_2p52]}
l1_double_eg_25_14_er2p5 <= double_eg_i121;
algo(5) <= l1_double_eg_25_14_er2p5;

-- 162 L1_TripleEG_18_17_8_er2p5 : comb{EG18[EG-ETA_2p52],EG17[EG-ETA_2p52],EG8[EG-ETA_2p52]}
l1_triple_eg_18_17_8_er2p5 <= triple_eg_i169;
algo(2) <= l1_triple_eg_18_17_8_er2p5;

-- 181 L1_SingleMu16 : MU16[MU-QLTY_SNGL]
l1_single_mu16 <= single_mu_i181;
algo(54) <= l1_single_mu16;

-- 185 L1_SingleMu25 : MU25[MU-QLTY_SNGL]
l1_single_mu25 <= single_mu_i166;
...
l1_cdc_single_mu_3_er1p2_top120_dphi2p618_3p142 <= muon_muon_correlation_i191;
algo(1) <= l1_cdc_single_mu_3_er1p2_top120_dphi2p618_3p142;
