...
algo(9) <= l1_double_eg8er2p5_htt320er;
...
algo(70) <= l1_single_jet30er2p5_not_bptx_or;
...
algo(47) <= l1_single_jet20er1p3to2p5_not_bptx_or;
...
algo(44) <= l1_single_jet20er1p3_not_bptx_or;
...
algo(71) <= l1_single_jet8_bptx_and;
...
algo(37) <= l1_single_jet20_bptx_and;
...
algo(60) <= l1_single_jet24_bptx_and;
...
algo(27) <= l1_single_jet8er1p3_bptx_and;
...
algo(55) <= l1_single_jet12er1p3_bptx_and;
...
algo(28) <= l1_double_eg2_bptx_and;
...
algo(34) <= l1_double_eg2er2p13_bptx_and;
...
algo(40) <= l1_double_eg3_bptx_and;
...
algo(51) <= l1_double_eg4er2p13_bptx_and;
