...
cond_single_eg_i468_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
-- number of objects and type
    ...
    port map(
        lhc_clk,
        obj1_calo => bx_data.eg(2),
        condition_o => single_eg_i468
    );

cond_single_eg_i469_i: entity work.comb_conditions
    generic map(
-- setting slice high value(s) instead of default value(s) ("NR_MU_OBJECTS-1" => 7)
        slice_1_high_obj1 => 11,
-- object cuts
...
algo(5) <= l1_double_mu0er1p5_sq_os_d_r_max1p4;
...
algo(4) <= l1_double_mu0er1p4_sq_os_d_r_max1p4;
...
algo(7) <= l1_double_mu3er2p0_sq_os_d_r_max1p6;
...
algo(8) <= l1_double_mu4er2p0_sq_os_d_r_max1p6;
...
algo(11) <= l1_double_mu5_sq_os_d_r_max1p6;
...
algo(41) <= l1_mu7_loose_iso_eg23er2p5;
...
l1_single_eg28er1p3 <= single_eg_i471;
algo(29) <= l1_single_eg28er1p3;

-- 178 L1_SingleEG28er1p3to2p5 : EG28[EG-ETA_2p52] AND  NOT EG28[EG-ETA_1p3]
l1_single_eg28er1p3to2p5 <= single_eg_i139 and not single_eg_i471;
algo(21) <= l1_single_eg28er1p3to2p5;

-- 179 L1_SingleEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52]
l1_single_eg28er2p5to3p0 <= single_eg_i469 and not single_eg_i139;
algo(24) <= l1_single_eg28er2p5to3p0;
...
l1_single_loose_iso_eg28er1p3 <= single_eg_i468;
...
l1_single_loose_iso_eg28er1p3to2p5 <= single_eg_i154 and not single_eg_i468;
algo(27) <= l1_single_loose_iso_eg28er1p3to2p5;

-- 196 L1_SingleLooseIsoEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52,EG-ISO_0xC]
l1_single_loose_iso_eg28er2p5to3p0 <= single_eg_i469 and not single_eg_i154;
algo(28) <= l1_single_loose_iso_eg28er2p5to3p0;
...
l1_single_iso_eg28er1p3 <= single_eg_i470;
...
l1_single_iso_eg28er1p3to2p5 <= single_eg_i164 and not single_eg_i470;
algo(20) <= l1_single_iso_eg28er1p3to2p5;

-- 208 L1_SingleIsoEG28er2p5to3p0 : EG28 AND  NOT EG28[EG-ETA_2p52,EG-ISO_0xA]
l1_single_iso_eg28er2p5to3p0 <= single_eg_i469 and not single_eg_i164;
...
l1_double_eg17_11_er1p2_d_r_max0p6 <= calo_calo_correlation_i473;
...
algo(43) <= l1_loose_iso_eg14er2p5_htt200er;
...
algo(44) <= l1_loose_iso_eg16er2p5_htt200er;
...
algo(32) <= l1_single_jet90_fwd2p5;
