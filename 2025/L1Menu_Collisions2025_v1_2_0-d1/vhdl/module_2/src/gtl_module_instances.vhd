...
-- 428 L1_CICADA_VLoose : CICADA[CICADA-CSCORE_55p75]
l1_cicada_v_loose <= cicada_trigger_i408;
algo(71) <= l1_cicada_v_loose;
...
algo(55) <= l1_single_jet12_bptx_and;
...
algo(27) <= l1_single_jet16_bptx_and;
...
algo(32) <= l1_single_jet8er1p3_bptx_and;
...
algo(61) <= l1_single_jet12er1p3_bptx_and;
...
algo(25) <= l1_single_eg7_bptx_and;
...
algo(47) <= l1_double_eg2er2p13_bptx_and;
...
algo(50) <= l1_double_eg3_bptx_and;
