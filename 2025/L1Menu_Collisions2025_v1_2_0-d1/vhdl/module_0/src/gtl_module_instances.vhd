...
algo(59) <= l1_single_mu0_sq14_bmtf;
...
algo(27) <= l1_double_mu0_upt15_upt7;
...
algo(12) <= l1_double_mu0er2p0_sq_d_eta_max1p5;
...
algo(11) <= l1_double_mu0er2p0_sq_os_d_eta_max1p5;
...
algo(10) <= l1_double_mu0er1p4_sq_os_d_eta_max1p2;
...
algo(9) <= l1_double_mu0er2p0_sq_os_d_eta_max0p3_d_phi_0p8to1p2;
...
algo(40) <= l1_triple_mu_3_sq_2p5_sq_0;
...
algo(7) <= l1_triple_mu_3_sq_2p5_sq_0_os_mass_max12;

-- 119 L1_SingleMuShower_Nominal : MUS0
l1_single_mu_shower_nominal <= muon_shower0_i83;
algo(75) <= l1_single_mu_shower_nominal;
...
algo(21) <= l1_single_iso_eg28_fwd2p5;
...
l1_double_eg16_er1p5_d_eta_max1p5 <= calo_calo_correlation_i474;
...
algo(41) <= l1_loose_iso_eg14er2p5_htt200er;
...
algo(43) <= l1_loose_iso_eg16er2p5_htt200er;
...
algo(18) <= l1_double_iso_tau28er2p1;
...
l1_double_tau_iso34_iso23_er2p1_jet55_rm_ovlp_d_r0p5 <= double_tau_ov_rm_i477;
...
-- 429 L1_CICADA_Loose : CICADA[CICADA-CSCORE_60p75]
l1_cicada_loose <= cicada_trigger_i409;
algo(67) <= l1_cicada_loose;

-- 433 L1_CICADA_VVTight : CICADA[CICADA-CSCORE_116p5]
l1_cicada_vv_tight <= cicada_trigger_i430;
algo(68) <= l1_cicada_vv_tight;

-- 461 L1_SingleEG5er1p52 : EG5[EG-ETA_1p52_HASHFIX]
l1_single_eg5er1p52 <= single_eg_i458;
algo(51) <= l1_single_eg5er1p52;
