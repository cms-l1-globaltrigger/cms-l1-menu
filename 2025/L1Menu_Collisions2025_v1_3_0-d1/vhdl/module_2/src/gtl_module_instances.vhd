...
algo(79) <= l1_single_mu_shower_tight;
...
algo(25) <= l1_single_jet30er2p5_not_bptx_or;
...
algo(55) <= l1_single_jet20er1p3to2p5_not_bptx_or;
...
algo(51) <= l1_single_jet20er1p3_not_bptx_or;
...
algo(34) <= l1_single_jet8_bptx_and;
...
algo(59) <= l1_single_jet12_bptx_and;
...
algo(26) <= l1_single_jet16_bptx_and;
...
algo(68) <= l1_single_jet24_bptx_and;
...
algo(44) <= l1_single_jet8er1p3_bptx_and;
...
algo(28) <= l1_single_jet16er1p3_bptx_and;
...
algo(47) <= l1_single_jet20er1p3_bptx_and;
...
algo(70) <= l1_single_jet24er1p3_bptx_and;
...
algo(43) <= l1_double_eg2_bptx_and;
...
algo(49) <= l1_double_eg2er2p13_bptx_and;
...
algo(56) <= l1_double_eg3er2p13_bptx_and;
...
algo(61) <= l1_double_eg4_bptx_and;
...
algo(66) <= l1_double_eg4er2p13_bptx_and;
...
algo(78) <= l1_hcal_laser_mon_trig;
