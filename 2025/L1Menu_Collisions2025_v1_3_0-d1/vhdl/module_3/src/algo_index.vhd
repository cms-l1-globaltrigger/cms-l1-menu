...
constant global_index: global_index_array := (
        ...
        398, -- module_index: 47, name: L1_ETM120
        416, -- module_index: 48, name: L1_HTMHF100
        391, -- module_index: 49, name: L1_HTT255er
        499, -- module_index: 50, name: L1_BPTX_AND_Ref3_VME
        502, -- module_index: 51, name: L1_BPTX_BeamGas_Ref2_VME
        481, -- module_index: 52, name: L1_BptxMinus
        480, -- module_index: 53, name: L1_BptxPlus
        479, -- module_index: 54, name: L1_BptxXOR
        483, -- module_index: 55, name: L1_UnpairedBunchBptxMinus
    others => 0
);
