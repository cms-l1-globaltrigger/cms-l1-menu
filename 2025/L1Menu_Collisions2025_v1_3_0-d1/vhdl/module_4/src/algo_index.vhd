...
constant global_index: global_index_array := (
        ...
        407, -- module_index: 63, name: L1_ETMHF140
        418, -- module_index: 64, name: L1_HTMHF125
        395, -- module_index: 65, name: L1_HTT400er
        503, -- module_index: 66, name: L1_BPTX_BeamGas_B1_VME
        495, -- module_index: 67, name: L1_BPTX_OR_Ref3_VME
        492, -- module_index: 68, name: L1_FirstCollisionInTrain
        119, -- module_index: 69, name: L1_SingleMuShower_Nominal
        510, -- module_index: 70, name: L1_TOTEM_3
    others => 0
);
