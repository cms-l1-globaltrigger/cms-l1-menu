...
constant global_index: global_index_array := (
        ...
        399, -- module_index: 69, name: L1_ETM150
        417, -- module_index: 70, name: L1_HTMHF120
        394, -- module_index: 71, name: L1_HTT360er
        500, -- module_index: 72, name: L1_BPTX_AND_Ref4_VME
        494, -- module_index: 73, name: L1_BPTX_NotOR_VME
        493, -- module_index: 74, name: L1_FirstCollisionInOrbit
        491, -- module_index: 75, name: L1_LastCollisionInTrain
        509, -- module_index: 76, name: L1_TOTEM_2
        482, -- module_index: 77, name: L1_UnpairedBunchBptxPlus
    others => 0
);
